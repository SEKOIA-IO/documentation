...
![SEKOIA.IO Operation Center O365 intake](../assets/tenant_o365.png){: style="max-width:60%"}
...
![SEKOIA.IO Operation Center O365 intake](../assets/intake_creation_o365.png){: style="max-width:60%"}
- Click on `LOG IN TO OFFICE 365`, then `ADD PERMISSION INTO OFFICE 365`
![SEKOIA.IO Operation Center O365 intake](../assets/intake_creation_o365_access.png){: style="max-width:60%"}
