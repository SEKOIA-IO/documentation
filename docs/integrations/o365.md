...
## I] Office365 logs
On Microsfit Office 365 API logs four categories of logs:
...
Sekoia has developed an automatical setup for collecting Microsfit Office 365 logs from its dedicated API.
...
In order to exploit the automatic interconnexion method, please follow these steps:
