...
- **Search the intelligence database:** Find current intelligence enriched with analyst research and contextual analysis. See [Intelligence database](features/consume/intelligence.md).
- **Set up custom feeds:** Follow topics relevant to your organization and receive updates when reports change. See [Feeds](features/consume/feeds.md).
- **Explore relationships:** Use [Graph Explorations](features/consume/graph_explorations.md) to investigate connections between threat actors, infrastructure, malware, and cases.
...
- Create and edit your [dashboards](features/monitor/dashboard.md) to monitor sectors, research output, or the evolution of your threat database.
