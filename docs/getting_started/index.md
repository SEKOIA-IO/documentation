---
title: "Welcome to Sekoia"
description: "Start here to discover Sekoia, set up your account, and begin protecting your organization."
keywords: [getting started, onboarding, sekoia, soc platform, analyst, admin, self-serve]
audience: all
module: all
type: concept
---
...
After you receive your invitation email, follow these steps to get started:

1. **Join** — Accept your invitation and join your workspace or community.
2. **Secure** — Enable two-factor authentication and set your preferences.
3. **Configure** — Connect your data sources and activate detection rules (admins and analysts working together).
4. **Train** — Follow the quick start guides and Academy courses at your own pace.
5. **Operate** — Start triaging alerts and investigating threats.
6. **Get help** — Use the support portal, Academy, and Community forum whenever you need assistance.
