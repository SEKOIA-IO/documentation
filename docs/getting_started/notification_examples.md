...
!!! tip "Recommended threshold"
    Set the inactivity duration to 1 hour for most intakes. For critical data sources such as an EDR (Endpoint Detection and Response) or Active Directory, use 15 or 30 minutes.
