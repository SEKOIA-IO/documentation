...
- Connecting external tools to the Sekoia API (SIEM (Security Information and Event Management), ticketing systems, SOAR (Security Orchestration, Automation and Response) platforms)
