...
| **Admin** | Full access including community management, user administration, and configuration | Security managers, platform administrators, MSSP (Managed Security Service Provider) operators |
