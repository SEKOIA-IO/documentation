...
- Your workspace administrator has confirmed your subscription is active. Review [Understand your subscription](/getting_started/understand_your_subscription) and [Monitor your usage](/getting_started/monitor_your_usage) before connecting a data source.
...
If your subscription includes Elevate, the next step is to activate AI-powered alert triage. See [Quick start: Elevate](/getting_started/quick_start_elevate).
...
- [Quick start: Elevate](/getting_started/quick_start_elevate): Activate AI-powered alert triage once your Defend environment is running.
