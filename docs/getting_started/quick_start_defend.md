---
title: "Quick start: Defend"
description: "A five-step tutorial to start protecting your organization with Sekoia Defend: from connecting your first data source to automating alert responses."
keywords: [quick start, defend, xdr, getting started, tutorial, intakes, detection rules, alerts, playbooks]
audience: analyst
module: defend
type: tutorial
---
...
- Your workspace administrator has confirmed your subscription is active. Review [Understand your subscription](/getting_started/understand_your_subscription.md) and [Monitor your usage](/getting_started/monitor_your_usage.md) before connecting a data source.
...
When you complete all five steps, you will have a functioning Sekoia Defend environment that collects your logs, detects threats as they arrive, and surfaces alerts for investigation. You will also have your first automated response workflow active.

If your subscription includes Elevate, the next step is to activate AI-powered alert triage. See [Quick start: Elevate](/getting_started/quick_start_elevate.md).
...
- [Quick start: Elevate](/getting_started/quick_start_elevate.md): Activate AI-powered alert triage once your Defend environment is running.
