...
| Detection Rules | Yes | Full rules catalog embedded in the release, updated daily. |
...
Detection capabilities remain fully operational. All Sekoia detection rules and integration connectors are embedded in every release and updated daily to keep your detection engine current without external connectivity.
...
| Attribute | Details |
| :--- | :--- |
| Support duration | Minimum 12 months from release date. |
| Supported patch | Support applies to the latest patch of each minor version only. |
| L1 / L2 support | Managed by your partner (MSSP or integrator). |
| L3 support | Provided by Sekoia during French business hours. |
| Update notifications | New releases are communicated by email to registered contacts. |
| Roadmap | Feature announcements are published at [https://roadmap.sekoia.io](https://roadmap.sekoia.io). |
