...
2. Set up the module configuration with the:
     ...
     - Vade Cloud API hostname: the URL of your admin interface of Vade Cloud. Most of the time this is `https://cloud.vadesecure.com`; tTO BE ADAPTED depending on your context.
