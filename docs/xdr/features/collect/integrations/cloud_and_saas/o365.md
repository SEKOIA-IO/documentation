...
- Have access to the Operations Center and be Administrator of the MS 0365 in order to create an intake
- Have an Azure Premium P1 or Azure Premium P2 license and configure the MS O365 logging in the GUI to generate logs
