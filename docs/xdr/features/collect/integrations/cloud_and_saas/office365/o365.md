...
!!!Important
Once the integration is created, it will take **at least** 15 minutes to retrieve the first events. 
It may take up to 12 hours for the Microsoft API to make data available for the first time.
