# How to forward logs to Sekoia.io from a third-party application using Syslog

Many third-party applications have the ability to centralize events and forward them using Syslog. Below, you can find some examples of usage. Please note that these solutions are not the official methods for sending logs to Sekoia.io.
