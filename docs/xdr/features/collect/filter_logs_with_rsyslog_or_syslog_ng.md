...
- A working Sekoia Forwarder deployment using Rsyslog or Syslog-ng. See [Sekoia Forwarder documentation](/integration/ingestion_methods/syslog/sekoiaio_forwarder/) for setup instructions.
