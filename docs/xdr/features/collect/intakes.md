...
Instead of building the parser stage by stage, you can let an AI agent generate it from sample logs. See [AI intake parser](/xdr/features/collect/ai_intake_parser.md) for how the agent works, and [Generate a parser with AI](/xdr/features/collect/generate_a_parser_with_ai.md) for the procedure.
