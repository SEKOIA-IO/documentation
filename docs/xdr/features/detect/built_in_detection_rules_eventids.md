...
| Correlation PowerShell Suspicious DLL Loading | intermediate | <span style="color:#5865d3"><a href='https://learn.microsoft.com/en-us/sysinternals/downloads/sysmon#events' style='color: inherit;'>5</a></span>, 53504 | Kernel-Process, Microsoft-Windows-PowerShell |
...
| Entra ID Sign-In Via Known AiTM Phishing Kit (CEPHAS 2FA) | elementary | <span style="color:#5865d3"><a href='https://learn.microsoft.com/en-us/sysinternals/downloads/sysmon#events' style='color: inherit;'>15</a></span> |  |
...
| EventID | Number of rules concerned | Percentage of rules concerned (Total rules: 516) |
| ------- | ------------------------- | ------------------------------------------------------ |
| 1 | 238 | 46.12 % |
| 13 | 52 | 10.08 % |
| 4104 | 46 | 8.91 % |
...
| EventProvider | Number of rules concerned | Percentage of rules concerned (Total rules: 516) |
| ------- | ------------------------- | ------------------------------------------------------ |
| Microsoft-Windows-Sysmon | 292 | 56.59 % |
| Microsoft-Windows-Security-Auditing | 87 | 16.86 % |
| Kernel-Process | 64 | 12.4 % |
| Microsoft-Windows-PowerShell | 50 | 9.69 % |
| Service Control Manager | 11 | 2.13 % |
| Microsoft-Windows-Kernel-File | 10 | 1.94 % |
| Microsoft-Windows-Windows Defender | 9 | 1.74 % |
| Microsoft-Windows-Kernel-Network | 3 | 0.58 % |
| Microsoft-Windows-DNS-Client | 2 | 0.39 % |
| Microsoft-Windows-Kernel-Process | 2 | 0.39 % |
| Microsoft-Windows-DHCP-Server | 2 | 0.39 % |
| Microsoft-Windows-NTLM | 1 | 0.19 % |
| ESENT | 1 | 0.19 % |
| Microsoft-REDACTED-Security-Auditing | 1 | 0.19 % |
| Microsoft-Windows-DNS-Server-Service | 1 | 0.19 % |
| Application Error | 1 | 0.19 % |
| Microsoft-Windows-Kernel-General | 1 | 0.19 % |
| Microsoft-Windows-Eventlog | 1 | 0.19 % |
| Microsoft-Windows-Backup | 1 | 0.19 % |
| Microsoft-Windows-Audit-CVE | 1 | 0.19 % |

## EffortLevel x EventIDs
| Effort Level | EventIDs | Number of related rules | Percentage of related rules (Total rules: 516 |
| ------------ | -------- | ----------------------- | ------------------------------------------------------- |
| master | 1, 10, 1013, 11, 1116, 12, 13, 15, 150, 17, 22, 25, 27, 3, 40, 4104, 4611, 4624, 4625, 4649, 4656, 4661, 4662, 4663, 4673, 4674, 4688, 4698, 4720, 4726, 4728, 4729, 4732, 4740, 4743, 4768, 5, 5007, 5140, 5145, 64, 7, 79016668, 8001, 83820799, 98 | 141 | 27.33 % |
| advanced | 1, 10, 11, 1116, 1127, 13, 15, 17, 21, 22, 23, 25, 3, 4103, 4104, 4624, 4625, 4656, 4662, 4688, 4706, 4707, 5, 5145, 5154, 5156, 6, 6416, 7, 7045, 8 | 116 | 22.48 % |
| intermediate | 1, 10, 1000, 1033, 1034, 11, 1102, 12, 13, 15, 16, 17, 20, 22, 3, 30, 4103, 4104, 4624, 4656, 4657, 4662, 4663, 4688, 4697, 47, 4703, 4720, 4738, 4741, 4768, 4794, 4799, 4825, 5, 5136, 5145, 524, 53504, 6, 7, 7045, 8 | 159 | 30.81 % |
| elementary | 1, 10, 11, 1116, 13, 15, 17, 25, 325, 4103, 4104, 4625, 4663, 4688, 4697, 4704, 4720, 4738, 4887, 5, 5136, 5145, 7, 7045, 8 | 100 | 19.38 % |