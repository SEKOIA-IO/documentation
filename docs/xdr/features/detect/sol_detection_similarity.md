...
* [Alert similarity](/xdr/features/operation_center/alerts.md#alert-similarity): The platform-wide similarity model, occurrence counter, and how similarity interacts with alert status.
