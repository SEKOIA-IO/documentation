...
* **Volume < 30 TB and stored in FRA1 region**: The rehydration process starts within 48 working hours.
* **Volume > 30 TB and/or not stored in FRA1 region**: Support will provide a custom solution and an estimated time of completion (ETA). 
