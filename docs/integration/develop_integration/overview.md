...
* **You want to ingest data from a product not supported by Sekoia, go to this** [**section**](overview.md#usecase-1-you-want-to-ingest-data-from-a-product-not-supported-by-sekoia)
* **You want to modify an existing intake, go to this** [**section**](overview.md#usecase-2-you-want-to-modify-an-existing-intake)
* **You want to create a new automation, go to this** [**section**](overview.md#usecase-3-you-want-to-create-a-new-automation)
...
!!! info Additional resources to support development:
...
If there are no compatible methods in Sekoia to collect events from your product, you can create a custom connector that will handle the collection process. Sekoia will trigger this connector on a recurring basis to connect to your product and collect new events.

!!! Prerequisites A custom connector requires Python development skills, as connectors are custom Python code developed using sekoia-automation SDK.
...
Once you have created your custom connector, return to Step 2 and edit your custom format. In the top right of the screen, select your custom connector to associate it with your custom format. When creating an intake using this format, the selected custom connector will be used to collect events.
...
!!! info To homologate your custom format, you will need to contribute through our Github repository
...
Once you have finished your modifications, [create a custom intake](overview.md#step-2-create-your-custom-intake) based on this new custom format.

### Usecase 3. You want to create a new automation

!!! warning Please note that all automations are available in the public library of the Sekoia SOC platform, making them accessible to other Sekoia customers. We are currently working on implementing private automations.
