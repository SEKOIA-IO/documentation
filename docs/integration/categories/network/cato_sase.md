...
In addition to the API key, Cato `account ID` is also required for the Account configuration in Sekoia, this `account ID` can be found in the browswer address of the Cato Management application, in the form of 4 or 5 digits.
