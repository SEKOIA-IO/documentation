...
name: SonicWall SMA 100 Series (deprecated)
type: intake
...
This setup guide will show you how to forward your SonicWall SMA 100 Series logs to Sekoia.io by means of a syslog transport channel.

### Prerequisites

- Have an internal log concentrator (Rsyslog).

### Enable Syslog forwarding for SonicWall SMA 100 Series

1. Log in to the SonicWall SMA 100 Series appliance's management interface.
...
4. In the syslog settings, type the ip address and the port of your log concentrator as Primary syslog server.
    ...
    ![SonicWall SMA 100 Series settings](/assets/instructions/sonicwall_sma_100_series/settings.png)
