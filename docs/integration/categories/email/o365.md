...
- In case of issues with permissions (HTTP 401 error), please check your subscriptions. If you see DLP.All, you can add the ActivityFeed.ReadDlp permission to your application.
