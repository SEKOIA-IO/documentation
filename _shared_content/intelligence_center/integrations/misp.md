...
To fetch SEKOIA.IO’s MISP feed, you’ll have to generate an API key with the `INTHREAT_READ_OBJECTS` permission. Please read the “[Generate API keys](https://docs.sekoia.io/getting_started/manage_api_keys/)“ and “[Permissions](https://docs.sekoia.io/getting_started/Permissions/)” page to understand how to create a new API key with the proper permissions.
