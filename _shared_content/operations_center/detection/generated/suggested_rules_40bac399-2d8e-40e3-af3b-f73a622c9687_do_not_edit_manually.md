...
Benefit from SEKOIA.IO built-in rules and upgrade **Skyhigh Secure Web Gateway / McAfee Web Gateway** with the following detection capabilities out-of-the-box.
