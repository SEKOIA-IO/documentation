...
=== "test_miscellaneous_7.json"

    ```json
	
    {
        "message": "conn=91520 op=1 SEARCH RESULT tag=101 err=0 nentries=1 text=",
        "event": {
...
=== "test_search_1.json"
    ...
    {
        "message": "\" conn=6521 op=3 SRCH base=\"\"ou=people,ou=IN,o=internal,dc=test\"\" scope=2 deref=0 filter=\"\"(&(exampleRole=example_admin)(uid=mhs))\"\"\"",
        "event": {
            "action": "srch",
            "category": [
                "network"
        ...
        "user": {
            "domain": "people.IN.internal.test"
        }
    }
