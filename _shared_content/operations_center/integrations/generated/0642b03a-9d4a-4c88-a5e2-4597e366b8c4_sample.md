...
=== "http_logs_3"
    ...
    ```
	2025-10-15T09:19:00.404Z info envoy[2527] [Originator@6876 sub=Default] [2025-10-15T09:18:52.450Z] "GET /stats?format=prometheus HTTP/1.1" 200 - 0 1389604 62 - "-" "VMware-client/8.0.3" "-" "localhost" "-"
    ```
...
=== "http_logs_4"
    ...
    ```
	2025-09-23T10:14:39.488Z info envoy[123456] [Originator@1234 sub=Default] 2025-09-23T10:14:38.383Z POST /api/search?q=hello+there HTTP/2 200 via_upstream - 56 77 9 8 0 1.2.3.4:40008 5.6.7.8:443 127.0.0.1:38482 127.0.0.1:12346
    ```
...
=== "other_events_type_7_partial"
    ...
    ```
	Event [11111111] [1-1] [2025-12-15T22:43:30.74689Z] [vim.event.GeneralUserEvent] [user] [VSPHERE.LOCAL\john-doe] [HOSTNAME] [11111111] [User logged event: Source: Veeam Backup
    ```
...
=== "others_events_type9"
    ...
    ```
	Event [21960200] [1-13] [2025-09-10T09:11:25.326825Z] [vim.event.VmReconfiguredEvent] [info] [VSPHERE.LOCAL\Administrator] [HOSTNAME] [21960199] [Reconfigured EXAMPLE on 1.2.3.4 in HOSTNAME.
    ```
...
=== "session_count"
    ...
    ```
	2025-10-23T12:05:23.489Z [authz-service-7 [] INFO com.vmware.cis.authorization.impl.AuthorizationManagerImpl opId=abcdef01] Session count for user [after add]: VSPHERE.LOCAL\USERNAME is 3
    ```
...
=== "session_logs_type3_with_spaced_hostname"
    ...
    ```
	Event [123456] [1-1] [2025-08-22T12:22:38.398001Z] [vim.event.UserLogoutSessionEvent] [info] [root] [NWT - Datacenter] [123456] [User root@127.0.0.1 logged out (login time: Friday, 22 August, 2025 12:22:38 PM, number of API invocations: 7, user agent: pyvmomi 8.0.2.0.1 internal Python/3.11.11 (VMkernel; 8.0.3; x86_64))]
    ```
...
=== "test_reconfigured_event"
    ...
    ```
	Event [8252317] [1-2] [2025-10-07T17:49:36.425874Z] [vim.event.VmReconfiguredEvent] [info] [VSPHERE.LOCAL\Administrator] [Datacenter] [1234567] [Reconfigured vm-name on source.domaine.local in Datacenter.
    ```
