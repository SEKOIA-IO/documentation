...
=== "test_event_firewall_blocked.json"

    ```json
	
    {
        "message": "{\"sourcetype\": \"zscalernss-fw\",\"event\": {\"datetime\": \"Mon Aug 28 16:43:59 2023\",\"login\": \"blocked.user@example.org\",\"locationname\": \"HQ\",\"clt_sport\": \"53321\",\"srv_dport\": \"445\",\"clt_sip\": \"10.0.0.10\",\"srv_dip\": \"10.0.1.20\",\"action\": \"Block/Drop\",\"nwsvc\": \"TCP\",\"nwapp\": \"telnet\",\"destcountry\": \"France\",\"duration\": \"12\",\"inbytes\": \"100\",\"outbytes\": \"0\",\"deviceowner\": \"blocked.user\"}}",
        "event": {
            "action": "block/drop",
            "category": [
                "network"
        ...
        "@timestamp": "2023-08-28T16:43:59Z",
        "destination": {
            "address": "10.0.1.20",
            "bytes": 0,
            "geo": {
	...
	
    {
        ...
        "zscaler": {
            "zia": {
                ...
                "department": "Financial%20Dept",
                "dlpdictionaries": "Test dictionaries",
                "dlpengine": "Test dlp",
...
|`zscaler.zia.appclass` | `keyword` | ZScaler app class |
...
|`zscaler.zia.dlpdictionaries` | `keyword` | ZScaler DLP (Data Loss Prevention) dictionaries |
|`zscaler.zia.dlpengine` | `keyword` | ZScaler DLP (Data Loss Prevention) engine, i.e. a collection of one or more DLP dictionaries, combined using logical operators, which can be used in DLP policies to detect specific content in the users' traffic |
|`zscaler.zia.event.outcome` | `keyword` | ZScaler event outcome |
|`zscaler.zia.event_id` | `keyword` | ZScaler event ID |
|`zscaler.zia.fileclass` | `keyword` | ZScaler file class |
...
|`zscaler.zia.pagerisk` | `keyword` | Web page risk index score evaluated by Suspicious Content Protection (Page Risk), to identify potentially harmful content |
...
|`zscaler.zia.unscannabletype` | `keyword` | ZScaler unscannable type |
