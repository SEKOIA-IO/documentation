            ...
            "client": {
                "x509": {
                    ...
                    "subject": {
                        ...
                        "common_name": "JOHNDOE.example.com"
                    }
                }
            }
        },
...
=== "test_failed_attempts_3.json"
    ...
    {
        "message": "CISE_Failed_Attempts 0000815085 5 4 IPSEC=IPSEC#Is IPSEC Device#No, Name=Endpoint Identity Groups:Profiled, Response={RadiusPacketType=AccessReject; AuthenticationResult=Passed; UserName=12:22:33:44:55:66; },#15",
        "event": {
            "category": [
                "network"
            ],
            "reason": "{RadiusPacketType=AccessReject; AuthenticationResult=Passed; UserName=12:22:33:44:55:66; }",
            "type": [
                "info"
            ]
        },
...
=== "test_mab_username_is_mac.json"

    ```json
	
    {
        "message": "CISE_Passed_Authentications 0000815090 6 5 NetworkDeviceName=switch01, UserName=02:1a:2b:3c:4d:5e, SelectedAuthenticationIdentityStores=Internal Endpoints,#15",
        "event": {
            "type": [
                "info"
            ]
...
=== "test_mab_username_is_mac_auth_status.json"

    ```json
	
    {
        "message": "CISE_Passed_Authentications 0000815091 6 5 UserName=aa:bb:cc:dd:ee:ff, AuthenticationStatus=AuthenticationPassed, NetworkDeviceName=switch02,#15",
        "event": {
            "category": [
                "authentication"
            ],
	...
	
    {
        ...
        "cisco": {
            "ise": {
                "acs_session_id": "HOST-01/000000000/000000",
                "nas": {
                    "identifier": "SW01-EDGE"
                },
                "network": {
                    "device_name": "SWITCH-GROUP-01"
                },
                "observer": {
                    "interface": {
                        "name": "ge-0/0/31.0",
        ...
        "destination": {
            ...
            "ip": "198.51.100.83",
            "mac": "40:9E:A4:0C:BD:80",
            "port": 1812
        },
        "host": {
            "name": "HOST-EXAMPLE-01"
        },
        "network": {
            "protocol": "Radius"
        },
...
=== "test_network_info_events5.json"
	...
	
    {
        ...
        "host": {
            "name": "iPhone-ABC1234.example.com"
        },
        "observer": {
            "product": "Cisco ISE",
            "vendor": "Cisco"
        ...
        "tls": {
            "client": {
                "x509": {
                    ...
                    "subject": {
                        "common_name": "WiFi iPhone-ABC1234.example.com Example Cert"
                    }
                }
            }
        }
...
=== "test_network_info_events6.json"
	...
	
    {
        ...
        "event": {
            ...
            "reason": "{UserName=02:00:00:00:00:01; User-Name=02-00-00-00-00-01; Class=CACS:01BCDEF023:ABC/111111/22222; cisco-av-pair-url-redirect-acl=GS-Redirect_ACL; cisco-av-pair-url-redirect=https://example.com; cisco-av-pair-profile-name=Unknown; LicenseTypes=1; }",
            "type": [
                "info"
            ]
        },
...
=== "test_network_info_events7.json"
	...
	
    {
        ...
        "destination": {
            "address": "iPhone-ABC123.example.com",
            "domain": "iPhone-ABC123.example.com",
            "mac": "02:00:00:00:00:01",
            "registered_domain": "example.com",
            "subdomain": "iPhone-ABC123",
            "top_level_domain": "com"
        },
        "observer": {
            "product": "Cisco ISE",
...
|`cisco.ise.nas.identifier` | `keyword` |  |
|`cisco.ise.network.device_name` | `keyword` | The network device name |
|`cisco.ise.observer.interface.name` | `keyword` |  |
|`cisco.ise.observer.interface.type` | `keyword` |  |
...
|`tls.client.x509.subject.alternative_names` | `keyword` |  |
