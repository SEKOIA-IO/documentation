                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "device",
                                    "values": [
                                        "{\"identifier\":null,\"hostname\":null,\"ip\":\"10.0.0.#36859\",\"mac\":null,\"subnet\":null,\"did\":62,\"sid\":25}"
                                    ]
                                }
                            ],
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "timestampRange",
                                    "values": [
                                        "{\"start\":1697334679535,\"end\":1697334713852}"
                                    ]
                                },
                                {
                                    "key": "Hostname",
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"malicious-example.org\",\"ip\":null}"
                                    ]
                                },
                                {
                                    "key": "Hostname rarity",
                                ...
                                },
                                {
                                    ...
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"198.51.100.23\",\"ip\":\"198.51.100.23\"}"
                                    ]
                                },
                                {
                                    "key": "Most recent ASN",
                                ...
                                },
                                {
                                    ...
                                    "type": "string",
                                    "values": [
                                        "/login/username=user1&password=P@ssw0rd!"
                                    ]
                                },
                                {
                                    "key": "Port",
	...
	
    {
        ...
        "darktrace": {
            "threat_visualizer": {
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "device",
                                    "values": [
                                        "{\"identifier\":\"SaaS::Zoom: john.doe@example.com\",\"hostname\":\"SaaS::Zoom: john.doe@example.com\",\"ip\":null,\"mac\":null,\"subnet\":null,\"did\":3820,\"sid\":-9}"
                                    ]
                                },
                                {
                                    "key": "Actor",
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"198.51.100.10\",\"ip\":\"198.51.100.10\"}"
                                    ]
                                },
                                {
                                    "key": "ASN",
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "timestampRange",
                                    "values": [
                                        "{\"start\":1730023230000,\"end\":1730023230000}"
                                    ]
                                },
                                {
                ...
                "summary": "The SaaS actor john.doe@example.com was observed making suspicious requests over a configured Zoom service from the IP 198.51.100.10.\n\nThis included requests made from unusual locations compared to the previous access locations observed from this actor and from the configured service in general.\n\nThough this behaviour could be the result of legitimate service usage or administration, it could also be a sign of this actor's account being hijacked by a malicious actor.\n\nConsequently, the security team may wish to confirm that this activity was legitimate and expected.",
...
=== "test_aianalyst_beacon.json"

    ```json
	
    {
        "message": "{\"summariser\":\"BeaconSummary\",\"acknowledged\":false,\"pinned\":false,\"createdAt\":1774984875778,\"attackPhases\":[2],\"mitreTactics\":[\"command-and-control\"],\"title\":\"Unusual Repeated Connections\",\"id\":\"de80f521-f2dd-4669-a98a-e8af28049dd3\",\"children\":[\"de80f521-f2dd-4669-a98a-e8af28049dd3\"],\"category\":\"critical\",\"currentGroup\":\"gde80f521-f2dd-4669-a98a-e8af28049dd3\",\"groupCategory\":\"suspicious\",\"groupScore\":4.0151966623350175,\"groupPreviousGroups\":[],\"activityId\":\"da39a3ee\",\"groupingIds\":[\"16a9efea\"],\"groupByActivity\":false,\"userTriggered\":false,\"externalTriggered\":false,\"aiaScore\":56.32070893611869,\"summary\":\"The device server01.example.local was observed initiating repeated connections over port 443 to the external IP 203.0.113.50.\\n\\nSuch beaconing activity is sometimes attributable to unwanted or potentially malicious software communicating with external command and control servers.\\n\\nIf this behaviour is unexpected, further investigation may be required to determine if this activity represents malicious command and control or legitimate telemetry of some form.\",\"periods\":[{\"start\":1774946813314,\"end\":1774982829564}],\"sender\":null,\"breachDevices\":[{\"identifier\":\"server01.example.local\",\"hostname\":\"server01.example.local\",\"ip\":\"10.2.11.33\",\"mac\":null,\"subnet\":null,\"did\":730,\"sid\":9}],\"relatedBreaches\":[{\"modelName\":\"Anomalous Server Activity / Rare External from Server\",\"pbid\":23616,\"threatScore\":23.0,\"timestamp\":1774984627000}],\"details\":[[{\"header\":\"Connections on Unusual Port\",\"contents\":[{\"key\":\"Time\",\"type\":\"timestampRange\",\"values\":[{\"start\":1774946813314,\"end\":1774982829564}]},{\"key\":\"Source device\",\"type\":\"device\",\"values\":[{\"identifier\":\"server01.example.local\",\"hostname\":\"server01.example.local\",\"ip\":\"10.2.11.33\",\"mac\":null,\"subnet\":null,\"did\":730,\"sid\":9}]},{\"key\":\"Destination port\",\"type\":\"integer\",\"values\":[443]},{\"key\":\"Transport protocol\",\"type\":\"string\",\"values\":[\"TCP\"]},{\"key\":\"Application protocols\",\"type\":\"string\",\"values\":[\"HTTPS\",\"SSL\"]},{\"key\":\"Country code\",\"type\":\"string\",\"values\":[\"IE\"]},{\"key\":\"Username observed prior to activity\",\"type\":\"string\",\"values\":[\"admin_user\"]},{\"key\":\"Source of username\",\"type\":\"string\",\"values\":[\"SMB login\"]},{\"key\":\"Time observed\",\"type\":\"timestamp\",\"values\":[1774946813576]}],\"uids\":[{\"relatedUids\":null,\"total\":null},{\"relatedUids\":[\"Cg8ADS2RVP1nMXOMra00\"],\"total\":1}]},{\"header\":\"Endpoint Details\",\"contents\":[{\"key\":\"Hostnames include\",\"type\":\"externalHost\",\"values\":[{\"hostname\":\"app1.example.com\",\"ip\":null},{\"hostname\":\"support.example.com\",\"ip\":null}]},{\"key\":\"Rarity of all hostnames\",\"type\":\"percentageRange\",\"values\":[{\"start\":100.0,\"end\":100.0}]},{\"key\":\"IP address\",\"type\":\"externalHost\",\"values\":[{\"hostname\":\"203.0.113.50\",\"ip\":\"203.0.113.50\"}]},{\"key\":\"IP rarity\",\"type\":\"percentageRange\",\"values\":[{\"start\":100.0,\"end\":100.0}]},{\"key\":\"ASN\",\"type\":\"string\",\"values\":[\"AS64496 Example ISP\"]}],\"uids\":[{\"relatedUids\":null,\"total\":null}]},{\"header\":\"Summary of Beaconing Activity\",\"contents\":[{\"key\":\"Median beacon period\",\"type\":\"duration\",\"values\":[0.03313493728637695]},{\"key\":\"Range of periods\",\"type\":\"durationRange\",\"values\":[{\"start\":9.5367431640625e-7,\"end\":1797.225774049759}]},{\"key\":\"Total number of beacon connections\",\"type\":\"integer\",\"values\":[736]},{\"key\":\"Range of data volumes sent per external connection\",\"type\":\"dataVolumeRange\",\"values\":[{\"start\":1767,\"end\":91784}]},{\"key\":\"Suspicious properties\",\"type\":\"string\",\"values\":[\"Endpoint was rare for the network\",\"Endpoint was new for the network\"]}],\"uids\":[{\"relatedUids\":[\"COXnnc3qIJnIc23hBk00\",\"CXQwCgDJ6OB47VkCi00\",\"CsSNofBIH1kiQLIMc00\",\"CDL3Ff3II5ZTZN5Ps100\",\"ChTC9OC2TX8yS3eu500\",\"CbGCDq12oQvmmlWHw500\",\"CZ8QEwfN1ovYeaK4500\",\"C5zLBVMkOFwyi3RKf00\",\"CQVVBn3oSIESa6msv400\",\"CP9dHjTb92GiGS7Wc00\"],\"total\":864}]}]],\"log_type\":\"aianalyst/incidentevents\"}",
        "event": {
            "category": "threat",
            "kind": "alert",
            "type": [
        ...
        "@timestamp": "2026-03-31T19:21:15.778000Z",
        "darktrace": {
            "threat_visualizer": {
                "acknowledged": false,
                "activityId": "da39a3ee",
                "aiaScore": 56.32070893611869,
                "attackPhases": [
                    2
                ],
                "breachDevices": [
                    {
                        ...
                        "identifier": "server01.example.local",
                        "ip": "10.2.11.33",
                        "mac": null,
                        "sid": 9,
                        "subnet": null
                ...
                "category": "critical",
                "children": [
                    "de80f521-f2dd-4669-a98a-e8af28049dd3"
                ],
                "currentGroup": "gde80f521-f2dd-4669-a98a-e8af28049dd3",
                "details": [
                    [
                        {
                            "contents": [
                                {
                                    ...
                                    "type": "timestampRange",
                                    "values": [
                                        "{\"start\":1774946813314,\"end\":1774982829564}"
                                    ]
                                },
                                {
                                    "key": "Source device",
                                    "type": "device",
                                    "values": [
                                        "{\"identifier\":\"server01.example.local\",\"hostname\":\"server01.example.local\",\"ip\":\"10.2.11.33\",\"mac\":null,\"subnet\":null,\"did\":730,\"sid\":9}"
                                    ]
                                },
                                {
                            ...
                            "header": "Connections on Unusual Port",
                            "uids": [
                                {
                                    "relatedUids": null,
                                    "total": null
                        ...
                        },
                        {
                            "contents": [
                                {
                                    "key": "Hostnames include",
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"app1.example.com\",\"ip\":null}",
                                        "{\"hostname\":\"support.example.com\",\"ip\":null}"
                                    ]
                                },
                                {
                                    "key": "Rarity of all hostnames",
                                ...
                                },
                                {
                                    ...
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"203.0.113.50\",\"ip\":\"203.0.113.50\"}"
                                    ]
                                },
                                {
                                    "key": "IP rarity",
                        ...
                        },
                        {
                            "contents": [
                                ...
                                },
                                {
                                    ...
                                    "type": "durationRange",
                                    "values": [
                                        "{\"start\":9.5367431640625e-7,\"end\":1797.225774049759}"
                                    ]
                                },
                                {
                                    "key": "Total number of beacon connections",
                                    "type": "integer",
                                    "values": [
                                        "736"
                                    ]
                                ...
                                },
                                {
                                    ...
                                    "type": "string",
                                    "values": [
                                        "Endpoint was rare for the network",
                                        "Endpoint was new for the network"
                                    ]
                                }
                            ],
                            "header": "Summary of Beaconing Activity",
                            "uids": [
                                {
                                    "relatedUids": [
                                        "COXnnc3qIJnIc23hBk00",
                                        "CXQwCgDJ6OB47VkCi00",
                                        "CsSNofBIH1kiQLIMc00",
                                        "CDL3Ff3II5ZTZN5Ps100",
                                        "ChTC9OC2TX8yS3eu500",
                                        "CbGCDq12oQvmmlWHw500",
                                        "CZ8QEwfN1ovYeaK4500",
                                        "C5zLBVMkOFwyi3RKf00",
                                        "CQVVBn3oSIESa6msv400",
                                        "CP9dHjTb92GiGS7Wc00"
                                    ],
                                    "total": 864
                                }
                ...
                "relatedBreaches": [
                    {
                        "modelName": "Anomalous Server Activity / Rare External from Server",
                        "pbid": 23616,
                        "threatScore": 23.0,
                        "timestamp": 1774984627000
                    }
                ],
                "summariser": "BeaconSummary",
                "summary": "The device server01.example.local was observed initiating repeated connections over port 443 to the external IP 203.0.113.50.\n\nSuch beaconing activity is sometimes attributable to unwanted or potentially malicious software communicating with external command and control servers.\n\nIf this behaviour is unexpected, further investigation may be required to determine if this activity represents malicious command and control or legitimate telemetry of some form.",
...
=== "test_aianalyst_without_log_type.json"
    ...
    {
        "message": "{\"summariser\":\"SaasBruteforceSummary\",\"acknowledged\":false,\"pinned\":false,\"createdAt\":1708649003457,\"attackPhases\":[2,4],\"mitreTactics\":[\"credential-access\"],\"title\":\"Possible Distributed Bruteforce of AzureActiveDirectory Account\",\"id\":\"dc5f69a5-ee78-4702-a999-ed64a9e873dc\",\"incidentEventUrl\":\"https://darktrace.example.com/saas#aiaincidentevent/dc5f69a5-ee78-4702-a999-ed64a9e873dc\",\"children\":[\"dc5f69a5-ee78-4702-a999-ed64a9e873dc\"],\"category\":\"suspicious\",\"currentGroup\":\"g7bd28910-7d7d-4971-9a20-48f12b8518e1\",\"groupCategory\":\"suspicious\",\"groupScore\":32.34820100820068,\"groupPreviousGroups\":[],\"activityId\":\"da39a3ee\",\"groupingIds\":[\"6ae71ab6\"],\"groupByActivity\":false,\"userTriggered\":false,\"externalTriggered\":false,\"aiaScore\":85.47036382887099,\"summary\":\"Repeated attempts to access the account user@example.com over a configured AzureActiveDirectory service were observed from a range of external IP addresses.\\n\\nThis included login attempts made from unusual locations for the account, and for the configured service in general.\\n\\nSince these requests originated from a wide variety of external sources, this could indicate a distributed attempt by a malicious actor to gain illegitimate access to this account.\\n\\nThe security team may therefore wish to ensure that the relevant credentials are sufficiently robust, and that additional measures such as multi-factor authentication are enabled where possible.\",\"periods\":[{\"start\":1708040149000,\"end\":1708648697000}],\"sender\":null,\"breachDevices\":[{\"identifier\":\"SaaS::AzureActiveDirectory: user@example.com\",\"hostname\":\"SaaS::AzureActiveDirectory: user@example.com\",\"ip\":null,\"mac\":null,\"subnet\":null,\"did\":2635,\"sid\":-9}],\"relatedBreaches\":[{\"modelName\":\"SaaS / Access / Password Spray\",\"pbid\":7130,\"threatScore\":47,\"timestamp\":1708648698000}],\"details\":[[{\"header\":\"SaaS User Details\",\"contents\":[{\"key\":\"SaaS account\",\"type\":\"device\",\"values\":[{\"identifier\":\"SaaS::AzureActiveDirectory: user@example.com\",\"hostname\":\"SaaS::AzureActiveDirectory: user@example.com\",\"ip\":null,\"mac\":null,\"subnet\":null,\"did\":2635,\"sid\":-9}]},{\"key\":\"Actor\",\"type\":\"string\",\"values\":[\"user@example.com\"]}]}],[{\"header\":\"Summary of Related Access Attempts\",\"contents\":[{\"key\":\"Attempts grouped by\",\"type\":\"string\",\"values\":[\"same targeted account\"]},{\"key\":\"Number of source ASNs\",\"type\":\"integer\",\"values\":[241]},{\"key\":\"Suspicious properties\",\"type\":\"string\",\"values\":[\"Unusual time for activity\",\"Unusual external source for activity\",\"Large number of login failures\"]}]},{\"header\":\"Details of Access Attempts\",\"contents\":[{\"key\":\"Time\",\"type\":\"timestampRange\",\"values\":[{\"start\":1708040149000,\"end\":1708648697000}]},{\"key\":\"Targeted account\",\"type\":\"string\",\"values\":[\"user@example.com\"]},{\"key\":\"Total number of login failures\",\"type\":\"integer\",\"values\":[1136]},{\"key\":\"Reasons for login failures\",\"type\":\"string\",\"values\":[\"Sign-in was blocked because it came from an IP address with malicious activity\",\"The account is locked, you've tried to sign in too many times with an incorrect user ID or password.\",\"Error validating credentials due to invalid username or password.\"]}]},{\"header\":\"Sources of Access Attempts\",\"contents\":[{\"key\":\"Source ASNs include\",\"type\":\"string\",\"values\":[\"AS64501 Example ISP 1\",\"AS64502 Example ISP 2\",\"AS64503 Example ISP 3\",\"AS64504 Example ISP 4\",\"AS64505 Example ISP 5\"]},{\"key\":\"Source IPs include\",\"type\":\"externalHost\",\"values\":[{\"hostname\":\"192.0.2.38\",\"ip\":\"192.0.2.38\"},{\"hostname\":\"192.0.2.204\",\"ip\":\"192.0.2.204\"},{\"hostname\":\"198.51.100.178\",\"ip\":\"198.51.100.178\"},{\"hostname\":\"198.51.100.17\",\"ip\":\"198.51.100.17\"},{\"hostname\":\"203.0.113.38\",\"ip\":\"203.0.113.38\"}]},{\"key\":\"Countries include\",\"type\":\"string\",\"values\":[\"China\",\"South Korea\",\"India\",\"United States\",\"Brazil\"]},{\"key\":\"User agent\",\"type\":\"string\",\"values\":[\"Office 365 Exchange Online\"]}]}]]}\n",
        "event": {
            "category": "network",
            "type": [
                "info"
        ...
        "darktrace": {
            "threat_visualizer": {
                ...
                "breachDevices": [
                    {
                        "did": 2635,
                        "hostname": "SaaS::AzureActiveDirectory: user@example.com",
                        "identifier": "SaaS::AzureActiveDirectory: user@example.com",
                        "ip": null,
                        "mac": null,
                        "sid": -9,
                        "subnet": null
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "device",
                                    "values": [
                                        "{\"identifier\":\"SaaS::AzureActiveDirectory: user@example.com\",\"hostname\":\"SaaS::AzureActiveDirectory: user@example.com\",\"ip\":null,\"mac\":null,\"subnet\":null,\"did\":2635,\"sid\":-9}"
                                    ]
                                },
                                {
                                    "key": "Actor",
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "timestampRange",
                                    "values": [
                                        "{\"start\":1708040149000,\"end\":1708648697000}"
                                    ]
                                },
                                {
                            ...
                            "contents": [
                                {
                                    ...
                                    "type": "string",
                                    "values": [
                                        "AS64501 Example ISP 1",
                                        "AS64502 Example ISP 2",
                                        "AS64503 Example ISP 3",
                                        "AS64504 Example ISP 4",
                                        "AS64505 Example ISP 5"
                                    ]
                                },
                                {
                                    ...
                                    "type": "externalHost",
                                    "values": [
                                        "{\"hostname\":\"192.0.2.38\",\"ip\":\"192.0.2.38\"}",
                                        "{\"hostname\":\"192.0.2.204\",\"ip\":\"192.0.2.204\"}",
                                        "{\"hostname\":\"198.51.100.178\",\"ip\":\"198.51.100.178\"}",
                                        "{\"hostname\":\"198.51.100.17\",\"ip\":\"198.51.100.17\"}",
                                        "{\"hostname\":\"203.0.113.38\",\"ip\":\"203.0.113.38\"}"
                                    ]
                                },
                                {
            ...
            "threat_visualizer": {
                ...
                "components": {
                    "filters": [
                        ...
                        {
                            "trigger_value": "repo.cloud.example.com",
                            "type": "Message"
                        },
                        {
                            "trigger_value": "true",
...
=== "test_email.json"
    ...
    {
        "message": "{\"url\": \"https://example.org/agemail/?uuid=11111111-1111-1111-1111-111111111111\", \"uuid\": \"11111111-1111-1111-1111-111111111111\", \"direction\": \"inbound\", \"from\": \"user2@example.com\", \"subject\": \"REDACTED\", \"timestamp\": \"2026-06-18 15:04:54.188000\", \"anomaly_score\": 9, \"tags\": [\"Mailer\", \"High Mailing History\", \"Graymail\"], \"recipients\": [\"user1@example.com\"], \"attachment_sha1s\": [], \"attachment_sha256s\": [], \"link_hosts\": [\"email.example.com\", \"yy.cloudfront.net\", \"medias.example.com\"], \"message_id\": \"<11111111111111111111111111111111111@example.com>\", \"actions\": [], \"recipient_actions\": {\"user1@example.com\": []}, \"attachment_names\": [], \"time\": 1781795094188}",
        "event": {
            "category": "network",
            "type": [
                "info"
        ...
        "@timestamp": "2026-06-18T15:04:54.188000Z",
        "darktrace": {
            "threat_visualizer": {
                "email": {
                    "anomaly_score": "9",
        ...
        "email": {
            ...
            "message_id": "<11111111111111111111111111111111111@example.com>",
            "subject": "REDACTED",
            "to": {
                "address": [
                    "user1@example.com"
...
=== "test_pentest.json"
    ...
    {
        "message": "{\"commentCount\":0,\"pbid\":25908,\"time\":1687811707000,\"creationTime\":1687811713000,\"model\":{\"then\":{\"name\":\"PenTest\",\"pid\":2721,\"phid\":9287,\"uuid\":\"8b3d5e73-0cf0-4c32-8451-a6919b9978f8\",\"logic\":{\"data\":[18021],\"type\":\"componentList\",\"version\":1},\"throttle\":1000,\"sharedEndpoints\":false,\"actions\":{\"alert\":true,\"antigena\":{},\"breach\":true,\"model\":true,\"setPriority\":false,\"setTag\":false,\"setType\":false},\"tags\":[],\"interval\":3600,\"delay\":0,\"sequenced\":true,\"active\":true,\"modified\":\"2023-04-17 11:34:25\",\"activeTimes\":{\"devices\":{},\"tags\":{},\"type\":\"exclusions\",\"version\":2},\"autoUpdatable\":true,\"autoUpdate\":true,\"autoSuppress\":true,\"description\":\"\",\"behaviour\":\"flat\",\"defeats\":[],\"created\":{\"by\":\"admin_user\",\"userID\":22},\"edited\":{\"by\":\"admin_user\",\"userID\":22},\"version\":7,\"priority\":5,\"category\":\"Critical\",\"compliance\":false},\"now\":{\"name\":\"PenTest\",\"pid\":2721,\"phid\":9287,\"uuid\":\"8b3d5e73-0cf0-4c32-8451-a6919b9978f8\",\"logic\":{\"data\":[18021],\"type\":\"componentList\",\"version\":1},\"throttle\":1000,\"sharedEndpoints\":false,\"actions\":{\"alert\":true,\"antigena\":{},\"breach\":true,\"model\":true,\"setPriority\":false,\"setTag\":false,\"setType\":false},\"tags\":[],\"interval\":3600,\"delay\":0,\"sequenced\":true,\"active\":true,\"modified\":\"2023-04-17 11:34:25\",\"activeTimes\":{\"devices\":{},\"tags\":{},\"type\":\"exclusions\",\"version\":2},\"autoUpdatable\":false,\"autoUpdate\":true,\"autoSuppress\":true,\"description\":\"\",\"behaviour\":\"flat\",\"defeats\":[],\"created\":{\"by\":\"admin_user\",\"userID\":22},\"edited\":{\"by\":\"admin_user\",\"userID\":22},\"version\":7,\"priority\":5,\"category\":\"Critical\",\"compliance\":false}},\"triggeredComponents\":[{\"time\":1687811706000,\"cbid\":25985,\"cid\":18021,\"chid\":29073,\"size\":1,\"threshold\":0,\"interval\":3600,\"logic\":{\"data\":{\"left\":\"A\",\"operator\":\"OR\",\"right\":{\"left\":\"B\",\"operator\":\"OR\",\"right\":{\"left\":\"C\",\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"A\",\"operator\":\"AND\",\"right\":{\"left\":\"B\",\"operator\":\"AND\",\"right\":{\"left\":\"C\",\"operator\":\"AND\",\"right\":\"D\"}}},\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"A\",\"operator\":\"AND\",\"right\":\"B\"},\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"B\",\"operator\":\"AND\",\"right\":\"C\"},\"operator\":\"OR\",\"right\":{\"left\":\"D\",\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"A\",\"operator\":\"AND\",\"right\":{\"left\":\"B\",\"operator\":\"AND\",\"right\":\"C\"}},\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"B\",\"operator\":\"AND\",\"right\":{\"left\":\"C\",\"operator\":\"AND\",\"right\":\"D\"}},\"operator\":\"OR\",\"right\":{\"left\":{\"left\":\"C\",\"operator\":\"AND\",\"right\":\"D\"},\"operator\":\"OR\",\"right\":{\"left\":\"A\",\"operator\":\"AND\",\"right\":\"D\"}}}}}}}}}}},\"version\":\"v0.1\"},\"ip\":\"192.168.16.100/32\",\"port\":80,\"metric\":{\"mlid\":16,\"name\":\"connections\",\"label\":\"Connections\"},\"triggeredFilters\":[{\"cfid\":217209,\"id\":\"C\",\"filterType\":\"Destinationport\",\"arguments\":{\"value\":80},\"comparatorType\":\"=\",\"trigger\":{\"value\":\"80\"}}]}],\"score\":1.0,\"device\":{\"did\":31,\"vendor\":\"\",\"ip\":\"192.168.1.2\",\"ips\":[{\"ip\":\"192.168.1.2\",\"timems\":1688389200000,\"time\":\"2023-07-0313:00:00\",\"sid\":3}],\"sid\":3,\"firstSeen\":1649669953000,\"lastSeen\":1688391406000,\"typename\":\"dnsserver\",\"typelabel\":\"DNSServer\"},\"log_type\":\"modelbreaches\"}",
        "event": {
            "category": "network",
        ...
        "darktrace": {
            "threat_visualizer": {
                ...
                "components": {
                    "filters": [
                        {
                            "trigger_value": "Probe probe-vsensor-01 (198.51.100.146) last contact was 50 hours ago",
                            "type": "Event details"
                        },
                        {
...
|`darktrace.threat_visualizer.details` | `array` | An array of detail sections for the AI Analyst incident event, each containing headers and key-value content entries describing the detected activity. |
...
|`darktrace.threat_visualizer.email.anomaly_score` | `keyword` | Anomaly score |
|`darktrace.threat_visualizer.email.link_hosts` | `keyword` | Link hosts |
|`darktrace.threat_visualizer.email.tags` | `keyword` | Tags |
...
|`darktrace.threat_visualizer.summariser` | `keyword` | The type of AI Analyst summariser that generated the incident event. (example value: 'BeaconSummary') |
|`darktrace.threat_visualizer.summary` | `keyword` | A human-readable summary of the AI Analyst incident event describing the detected activity. |
|`darktrace.threat_visualizer.time` | `number` | The timestamp when the record was created in epoch time. |
|`darktrace.threat_visualizer.title` | `keyword` | The title of the AI Analyst incident event. (example value: 'Unusual Repeated Connections') |
...
For more information on the Intake Format, please find the code of the Parser, Smart Descriptions, and Supported Events [here](https://github.com/SEKOIA-IO/intake-formats/tree/main/Darktrace/darktrace-threat-visualizer).