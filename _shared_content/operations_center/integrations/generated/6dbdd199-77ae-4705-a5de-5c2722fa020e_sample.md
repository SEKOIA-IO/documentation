...
=== "test_empty_bytes"
    ...
    ```
	1.2.3.4 - - [26/Aug/2025:11:18:29 +0200] "POST /index HTTP/1.1" 401 - "-" "Outlook-iOS-Android/1.0"
    ```
...
=== "test_security_log_event_with_tags"

    ```
	{
        "logAlertUid": "68b329da9893e34099c7d8ad5cb9c940",
        "timestamp": "1769614718399",
        "@timestamp": "1769614718399",
        "request": {
            "body": "REDACTED",
            "cookies": [
            ...
            "headers": [
                {
                    "key": "Content-Type",
                    "value": "application/vnd.ms-sync.wbxml"
                },
                {
                    "key": "Accept",
                    "value": "*/*"
                ...
                {
                    "key": "User-Agent",
                    "value": "Apple-iPhone14C3/2206.76"
                },
                {
                    "key": "Host",
                    "value": "example.com"
        ...
        "context": {
            ...
            "geoipCode": "",
            "geoipName": "",
            "applianceName": "xproxy123",
            "applianceUid": "68b329da9893e34099c7d8ad5cb9c940",
            "backendHost": "1.1.1.1",
            "backendPort": 80,
            "reverseProxyName": "xproxy123 - instance production",
            "reverseProxyUid": "68b329da9893e34099c7d8ad5cb9c940",
            "tunnelName": "tunnel example.com #1",
            "tunnelUid": "68b329da9893e34099c7d8ad5cb9c940",
            "workflowName": "WF - DGDDI - example.com - v1.0",
            "workflowUid": "68b329da9893e34099c7d8ad5cb9c940"
        },
        "events": [
            {
                "eventUid": "68b329da9893e34099c7d8ad5cb9c940",
                "tokens": {
                    "date": 1769614718401387,
                    "eventType": "security",
                    "engineUid": "icxEngine",
                    "engineName": "ICX Engine",
                    ...
                    "resolveType": "Default Resolve",
                    "part": "Multiple",
                    "icxPolicyName": "DGDDI - ICX - 3.46 example.com",
                    "icxPolicyUid": "68b329da9893e34099c7d8ad5cb9c940",
                    "icxRuleName": "Command Injection",
                    "icxRuleUid": "68b329da9893e34099c7d8ad5cb9c940",
                    "matchingParts": [
                        {
                            "part": "Var_GET",
                            "partKey": "Cmd",
                            "partKeyOperator": "pattern",
                            "partKeyPatternUid": "CommandInjectionProprietaryPattern_CI-00749-3.46.0",
                            "partKeyPatternName": "Command Injection",
                            "partKeyPatternVersion": "CI-00749-3.46.0",
                            "partKeyMatch": "Cmd",
                            "partValue": "Sync",
                            "partValueOperator": "regexp",
                            "partValuePattern": ".*",
                            "partValueMatch": "Sync",
                            "attackFamily": "Command Injection",
                            "riskLevel": 80,
                    ...
                    "reason": "ICX Engine: Command Injection in Var_GET 'Cmd'",
                    "securityExceptionConfigurationUid": "68b329da9893e34099c7d8ad5cb9c940"
                }
            }
        ]
    }
