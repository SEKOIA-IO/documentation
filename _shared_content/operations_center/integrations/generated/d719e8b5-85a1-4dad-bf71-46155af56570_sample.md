...
=== "connection_allow_duration_seconds"

    ```
	1.0|WatchGuard|XTM|12.12.B733447|30000151|host_name=FIREBOX-HOST	serial=000000000000	policy=Outgoing-00	disp=Allow	in_if=LAN	out_if=INTERNET	geo_dst=GBR	src=10.10.10.10	srcPort=31232	srcPostNAT=203.0.113.10	dst=198.51.100.20	dstPort=8814	src_user=user@example.local	flags=Dd	duration=42 seconds	sent_pkts=1	rcvd_pkts=1	sent_bytes=218	rcvd_bytes=204	
    ```
