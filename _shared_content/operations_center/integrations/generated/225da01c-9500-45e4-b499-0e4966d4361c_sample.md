...
=== "test_session_policy_added"

    ```
	site=pra.tenant.com;when=1782726944;who=toto;who_ip=1.2.3.4;event=group_policy_session_policy_added;group_policy:id=3177;group_policy:name=GROUPE_TEST_INTEGRATION;session_policy:purpose=unattended;session_policy:id=226;session_policy:name=Standard Session Policy
    ```
