...
=== "query_log.json"
    ...
    {
        "message": "client @0x7f62b80115d0 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA + (192.168.100.102)",
        "dns": {
            "header_flags": [
                "RD"
            ],
...
=== "query_log_cd.json"
    ...
    {
        "message": "client 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA +TC (192.168.100.102)",
        "dns": {
            "header_flags": [
                "CD",
                "RD"
...
=== "query_log_tcp.json"
    ...
    {
        "message": "client 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA +ET (192.168.100.102)",
        "dns": {
            "header_flags": [
                "RD"
            ],
...
|`bind.rpz.view` | `keyword` | The BIND view associated with the zone. |
