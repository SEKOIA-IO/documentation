...
=== "event_log_analytics.json"

    ```json
	
    {
        "message": "{\"Computer\":\"host-win-prd-01\",\"EventCategory\":0,\"EventData\":\"<DataItem Type=\\\"System.XmlData\\\" time=\\\"2026-07-06T12:15:56.2508625Z\\\"><EventData xmlns=\\\"http://schemas.microsoft.com/win/2004/08/events/event\\\"><Data Name=\\\"param1\\\">\\\"C:\\\\\\\\Windows\\\\system32\\\\BackgroundTaskHost.exe\\\" -ServerName:BackgroundTaskHost.WebAccountProvider</Data></EventData></DataItem>\",\"EventID\":10001,\"EventLevel\":2,\"EventLevelName\":\"Error\",\"EventLog\":\"System\",\"RenderedDescription\":\"Unable to start a DCOM Server\",\"Source\":\"Microsoft-Windows-DistributedCOM\",\"SourceSystem\":\"OpsManager\",\"Type\":\"Event\",\"UserName\":\"EXAMPLE\\\\john.doe\",\"TimeGenerated\":\"2026-07-06T12:15:56.2508625Z\",\"TenantId\":\"11111111-2222-3333-4444-555555555555\"}",
        "event": {
            "code": "10001",
            "outcome": "success",
        ...
        "host": {
            "hostname": "host-win-prd-01",
            "name": "host-win-prd-01"
        },
        "log": {
            "hostname": "host-win-prd-01"
        },
...
=== "heartbeat_log_analytics.json"

    ```json
	
    {
        "message": "{\"Category\":\"Azure Monitor Agent\",\"Computer\":\"host-win-dev-01\",\"ComputerEnvironment\":\"Azure\",\"ComputerIP\":\"203.0.113.21\",\"ComputerPrivateIPs\":[\"192.0.2.14\"],\"ManagementGroupName\":\"AOI-11111111-2222-3333-4444-555555555555\",\"MG\":\"00000000-0000-0000-0000-000000000001\",\"OSMajorVersion\":\"10\",\"OSMinorVersion\":\"0\",\"OSName\":\"Microsoft Windows 11 Enterprise multi-session\",\"OSType\":\"Windows\",\"Resource\":\"host-win-dev-01\",\"ResourceGroup\":\"rg-example\",\"ResourceId\":\"/subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/rg-example/providers/Microsoft.Compute/virtualMachines/host-win-dev-01\",\"SourceSystem\":\"OpsManager\",\"SubscriptionId\":\"11111111-2222-3333-4444-555555555555\",\"Type\":\"Heartbeat\",\"Version\":\"1.43.0.0\",\"TimeGenerated\":\"2026-07-06T12:16:10.9705608Z\",\"_ItemId\":\"aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee\",\"TenantId\":\"11111111-2222-3333-4444-555555555555\"}",
        "event": {
            "outcome": "success",
            "provider": "Azure Monitor Agent"
        },
        "action": {
            "outcome": "success",
            "type": "Heartbeat"
        ...
        "host": {
            "hostname": "host-win-dev-01",
            "name": "host-win-dev-01"
        },
        "log": {
            "hostname": "host-win-dev-01"
        },
...
|`action.properties.Domain` | `keyword` | The domain of user |
|`action.properties.Name` | `keyword` | The username |
|`action.properties.OpcodeValue` | `number` | The opcode |
|`action.properties.Type` | `keyword` | The type of user |
