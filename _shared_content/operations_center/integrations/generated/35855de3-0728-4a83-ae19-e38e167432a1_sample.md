...
=== "test_miscellaneous_7"

    ```
	conn=91520 op=1 SEARCH RESULT tag=101 err=0 nentries=1 text=
    ```
...
=== "test_search_1"
    ...
    ```
	" conn=6521 op=3 SRCH base=""ou=people,ou=IN,o=internal,dc=test"" scope=2 deref=0 filter=""(&(exampleRole=example_admin)(uid=mhs))"""
    ```
