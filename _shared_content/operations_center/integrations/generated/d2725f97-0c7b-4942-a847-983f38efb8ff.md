...
=== "salesforce_content_transfer_event.json"

    ```json
	
    {
        "message": "{\"EVENT_TYPE\":\"ContentTransfer\",\"TIMESTAMP\":\"20260729173610.030\",\"REQUEST_ID\":\"SLB:00000000000000000000000000000000\",\"TRANSACTION_TYPE\":\"VersionRenditionDownload\",\"ORGANIZATION_ID\":\"00D000000000001\",\"USER_ID\":\"005000000000002\",\"DOCUMENT_ID\":\"069000000000001\",\"VERSION_ID\":\"068000000000001\",\"FILE_TYPE\":\"PDF\",\"FILE_PREVIEW_TYPE\":\"THUMB120BY90\",\"SIZE_BYTES\":\"11763\",\"TIMESTAMP_DERIVED\":\"2026-07-29T17:36:10.030Z\",\"USER_ID_DERIVED\":\"005000000000002AAA\",\"DOCUMENT_ID_DERIVED\":\"069000000000001AAA\",\"VERSION_ID_DERIVED\":\"068000000000001AAA\"}",
        "event": {
            "action": "VersionRenditionDownload",
            "category": [
                "network"
            ],
            "dataset": "ContentTransfer",
            "type": [
                "info"
            ]
        },
        "@timestamp": "2034-03-15T22:01:57.361003Z",
        "organization": {
            "id": "00D000000000001"
        },
        "salesforce": {
            ...
            "request": {
                "id": "SLB:00000000000000000000000000000000"
            },
            "transaction": {
                "type": "VersionRenditionDownload"
            }
        },
        "user": {
            "id": "005000000000002"
...
=== "salesforce_database_save_event.json"

    ```json
	
    {
        "message": "{\"EVENT_TYPE\":\"DatabaseSave\",\"TIMESTAMP\":\"20260730035323.956\",\"REQUEST_ID\":\"TID:000000000000000001\",\"ORGANIZATION_ID\":\"00D000000000001\",\"USER_ID\":\"005000000000001\",\"KEY_PREFIX\":\"0AX\",\"DML_TYPE\":\"UPDATE\",\"NUM_ROWS\":\"1\",\"SAMPLE_FACTOR\":\"0\",\"FIRST_ENTITY_ID\":\"0AX000000000001\",\"SESSION_KEY\":\"REDACTED_SESSION_KEY\",\"LOGIN_KEY\":\"REDACTED_LOGIN_KEY\",\"TIMESTAMP_DERIVED\":\"2026-07-30T03:53:23.956Z\"}",
        "event": {
            "action": "UPDATE",
            "category": [
                "network"
            ],
            "dataset": "DatabaseSave",
            "type": [
                "info"
            ]
        },
        "@timestamp": "2034-03-15T22:03:23.532396Z",
        "organization": {
            "id": "00D000000000001"
        },
        "salesforce": {
            ...
            "login": {
                "key": "REDACTED_LOGIN_KEY"
            },
            "request": {
                "id": "TID:000000000000000001"
            },
            "session": {
                "key": {
                    "id": "REDACTED_SESSION_KEY"
                }
            }
        },
        "user": {
...
=== "salesforce_login_event.json"
	...
	
    {
        ...
        "url": {
            ...
            "full": "https://login.salesforce.com",
...
=== "salesforce_login_event_invalid_client_ip.json"

    ```json
	
    {
        "message": "{\"EVENT_TYPE\":\"Login\",\"TIMESTAMP\":\"20260916085959.605\",\"REQUEST_ID\":\"request_id_test_2\",\"ORGANIZATION_ID\":\"org-12345678\",\"USER_ID\":\"111111\",\"RUN_TIME\":\"163\",\"CPU_TIME\":\"28\",\"URI\":\"/XIApi\",\"SESSION_KEY\":\"\",\"LOGIN_KEY\":\"xxxxxxxxxxxxx\",\"USER_TYPE\":\"Standard\",\"REQUEST_STATUS\":\"\",\"DB_TOTAL_TIME\":\"88194839\",\"LOGIN_TYPE\":\"A\",\"BROWSER_TYPE\":\"\",\"API_TYPE\":\"\",\"API_VERSION\":\"9998.0\",\"USER_NAME\":\"integration@example.com\",\"TLS_PROTOCOL\":\"TLSv1.3\",\"CIPHER_SUITE\":\"TLS_AES_256_GCM_SHA384\",\"USE_API_TOKEN\":\"T\",\"HTTP_REFERER\":\"\",\"LOGIN_URL\":\"https://example.com\",\"COUNTRY_CODE\":\"FR\",\"AUTHENTICATION_METHOD_REFERENCE\":\"\",\"LOGIN_SUB_TYPE\":\"oauthpassword\",\"AUTHENTICATION_SERVICE_ID\":\"\",\"AUTHENTICATION_CONTEXT_CLASS_REFERENCE\":\"\",\"TIMESTAMP_DERIVED\":\"2026-09-16T08:59:59.605Z\",\"USER_ID_DERIVED\":\"111111\",\"CLIENT_IP\":\"Salesforce.com IP\",\"URI_ID_DERIVED\":\"\",\"LOGIN_STATUS\":\"LOGIN_NO_ERROR\",\"SOURCE_IP\":\"203.0.113.2\",\"FORWARDED_FOR_IP\":\"Salesforce.com IP\"}",
        "event": {
            "category": [
                "authentication"
            ],
        ...
        "@timestamp": "2034-03-16T03:13:28.595961Z",
        "organization": {
            "id": "org-12345678"
        },
        "related": {
        ...
        "salesforce": {
            ...
            "login": {
                "key": "xxxxxxxxxxxxx",
                "status": "LOGIN_NO_ERROR",
                "sub_type": "oauthpassword"
            },
            "request": {
                "id": "request_id_test_2"
            },
            "user": {
                "type": "Standard"
            }
...
=== "salesforce_report_event.json"
	...
	
    {
        ...
        "url": {
            ...
            "full": "https://example.salesforce.com/001/o",
...
|`salesforce.dml.type` | `keyword` | Salesforce dml type |
|`salesforce.document.id` | `keyword` | Salesforce document id |
|`salesforce.entity.id` | `keyword` | Salesforce entity id |
...
|`salesforce.transaction.type` | `keyword` | Salesforce transaction type |
