...
=== "sigflow_alert_2"
    ...
    ```json
	{
        ...
        "flow": {
            ...
            "bytes_toserver": 4278,
            "pkts_toserver": 31,
            "start": "2026-01-21T17:43:21.878627+0000"
        },
        "event": {
            "created": "2026-01-21T17:43:25.716401+0000",
            "kind": "alert",
            "module": "sigflow_alert",
            "severity": 3,
            "category": [
        ...
        "network": {
            ...
            "timestamp": "2026-01-21T17:43:25.716401+0000"
        },
        "observer": {
            "vendor": "name",
            "gcap": {
        ...
        "@timestamp": "2026-01-21T17:43:51.740Z",
        "@version": "1",
        "sigflow": {
            "stream": 0,
            "action": "allowed",
...
=== "test_email"
    ...
    ```json
	{
        "email": {
            ...
            "from": {
                "address": "\"sharp\" <user@company.org>"
            },
            "status": "PARSE_DONE",
            "attachments": [
                "File_name.pdf"
        ...
        "event": {
            "created": "2026-01-22T13:11:12.873340+0000",
            "kind": "alert",
            "module": "malcore",
            "severity": 0,
            "category": [
        ...
        "network": {
            ...
            "timestamp": "2026-01-22T13:11:12.873340+0000"
        },
        "observer": {
            "vendor": "gatewatcher",
            "gcap": {
        ...
        "timestamp": "2026-01-22T13:12:23.651131028Z",
        "smtp": {
            "helo": "sg",
...
=== "test_email_2"
    ...
    ```json
	{
        "@timestamp": "2026-04-23T00:51:16.611602587Z",
        "destination": {
            "ip": "1.2.3.4",
            "mac": "00:11:22:33:44:55",
            "port": 25
        ...
        "email": {
            ...
            "from": {
                "address": "\"Company Name\" <john.doe@company.com.smth>"
            },
            "status": "PARSE_DONE",
            "to": {
                "address": [
        ...
        "event": {
            ...
            "created": "2026-04-23T00:50:16.344579+0000",
            "dataset": "alert",
            "id": "11111111-1111-1111-1111-111111111111",
            "kind": "alert",
            "module": "malcore",
        ...
        "malcore": {
            ...
            "engine_id": {
                "0": {
                    "id": "1111111",
                    "scan_result": "INFECTED",
                    "threat_details": "JS/TrojanDownloader.Agent.AEHZ trojan"
                }
            },
        ...
        "network": {
            ...
            "flow_id": 1111111111111111,
            "protocol": "smtp",
            "timestamp": "2026-04-23T00:50:16.344579+0000",
            "transport": "tcp",
            "vlan": {
                "id": 2
            }
...
=== "test_email_3"
    ...
    ```json
	{
        ...
        "email": {
            ...
            "from": {
                "address": "\"JOHN DOE - Company\" <john.doe@company.com.smth>"
            },
            "status": "PARSE_DONE",
            "to": {
                "address": [
