...
=== "message_id3.json"
    ...
    {
        "message": "ABA141A0109: message-id=<CA+Os9Jhu1rkDJCREmGWt+M2bTfgAP0LYhxGoW=Sus4Pbu7cWgA@mail.gmail.com>",
        "event": {
            "category": [
                "email"
            ],
        ...
        "email": {
            "message_id": "CA+Os9Jhu1rkDJCREmGWt+M2bTfgAP0LYhxGoW=Sus4Pbu7cWgA@mail.gmail.com"
        },
        "network": {
            "protocol": "smtp"
        },
...
=== "opendkim.json"
    ...
    {
        "message": "host01 opendkim[778]: 720B91122280: DKIM-Signature field added (s=test01, d=something-group.com)",
        "event": {
            "category": [
                "email"
            ],
        ...
        "postfix": {
            "opendkim": {
                "selector": "test01",
                "signing_domain": "something-group.com"
            },
            "queue_id": {
                "local": "720B91122280"
            }
...
=== "test_disconnect_with_helo.json"

    ```json
	
    {
        "message": "disconnect from mail-gateway.example.com[1.2.3.4] helo=1 mail=1 rcpt=1 data=1 quit=1 commands=5",
        "event": {
            "category": [
                "email"
            ],
        ...
        "source": {
            "address": "mail-gateway.example.com",
            "domain": "mail-gateway.example.com",
            "ip": "1.2.3.4",
            "registered_domain": "example.com",
            "subdomain": "mail-gateway",
            "top_level_domain": "com"
        }
    }
...
|`postfix.opendkim.selector` | `keyword` |  |
|`postfix.opendkim.signing_domain` | `keyword` |  |
|`postfix.orig_to` | `keyword` |  |
|`postfix.queue_id.local` | `keyword` |  |
|`postfix.queue_id.remote` | `keyword` |  |
