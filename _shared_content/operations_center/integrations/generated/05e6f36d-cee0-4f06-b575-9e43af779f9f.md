...
|`process.parent.user.domain` | `keyword` | Domain of the account that ran the parent process responsible for the event |
|`process.parent.user.email` | `keyword` | User principal name (UPN) of the account that ran the parent process responsible for the event |
|`process.parent.user.id` | `keyword` | Security Identifier (SID) of the account that ran the parent process responsible for the event |
|`process.parent.user.name` | `keyword` | User name of the account that ran the parent process responsible for the event |
