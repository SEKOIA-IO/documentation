...
=== "query_log"
    ...
    ```
	client @0x7f62b80115d0 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA + (192.168.100.102)
    ```
...
=== "query_log_cd"
    ...
    ```
	client 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA +TC (192.168.100.102)
    ```
...
=== "query_log_tcp"
    ...
    ```
	client 192.168.101.70#55575 (docs.sekoia.com): query: docs.sekoia.com IN AAAA +ET (192.168.100.102)
    ```
