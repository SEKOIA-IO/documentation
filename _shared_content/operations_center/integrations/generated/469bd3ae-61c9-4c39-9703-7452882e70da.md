...
|`cato.ad_name` | `keyword` | Cato SASE AD name |
|`cato.application` | `keyword` | Cato SASE application |
|`cato.authentication_type` | `keyword` | Cato SASE authentication type |
|`cato.categories` | `list` | Cato SASE categories |
|`cato.client_class` | `keyword` | Cato SASE client class |
|`cato.configured_host_name` | `keyword` | Cato SASE configured host name |
|`cato.custom_categories` | `keyword` | Cato SASE custom categories |
|`cato.custom_category` | `keyword` | Cato SASE custom category |
|`cato.dest_is_site_or_vpn` | `keyword` | Cato SASE destination is site or VPN |
|`cato.dest_site` | `keyword` | Cato SASE destination site |
|`cato.dest_site_name` | `keyword` | Cato SASE destination site name |
|`cato.directory_host_name` | `keyword` | Cato SASE directory host name |
|`cato.directory_ip` | `keyword` | Cato SASE directory IP |
|`cato.directory_sync_result` | `keyword` | Cato SASE directory sync result |
|`cato.directory_sync_type` | `keyword` | Cato SASE directory sync type |
|`cato.domain_name` | `keyword` | Cato SASE domain name |
|`cato.event_sub_type` | `keyword` | Cato SASE event sub type |
|`cato.event_type` | `keyword` | Cato SASE event type |
|`cato.incident_aggregation` | `keyword` | Cato SASE incident aggregation |
|`cato.incident_id` | `keyword` | Cato SASE incident ID |
|`cato.link_type` | `keyword` | Cato SASE link type |
|`cato.login_type` | `keyword` | Cato SASE login type |
|`cato.pop_name` | `keyword` | Cato SASE PoP name |
|`cato.registration_code` | `keyword` | Cato SASE registration code |
|`cato.risk_level` | `keyword` | Cato SASE risk level |
|`cato.src_is_site_or_vpn` | `keyword` | Cato SASE source is site or VPN |
|`cato.src_site` | `keyword` | Cato SASE source site |
|`cato.src_site_name` | `keyword` | Cato SASE source site name |
|`cato.subnet_name` | `keyword` | Cato SASE subnet name |
|`cato.threat_name` | `keyword` | Cato SASE threat name |
|`cato.threat_reference` | `keyword` | Cato SASE threat reference |
|`cato.threat_type` | `keyword` | Cato SASE threat type |
|`cato.threat_verdict` | `keyword` | Cato SASE threat verdict |
|`cato.tunnel_protocol` | `keyword` | Cato SASE tunnel protocol |
|`cato.windows_domain_name` | `keyword` | Cato SASE Windows domain name |
