...
=== "admin-initiator.json"
    ...
    {
        "message": "{\"id\":\"4444444444444444444444\",\"creationDate\":\"2024-07-23T13:28:32.594Z\",\"source\":\"admin\",\"category\":null,\"type\":\"MessageCreated\",\"content\":{\"message\":{\"id\":\"1111111111111111111111\",\"title\":\"test\",\"content\":\"envoye a 15:28\",\"creationDate\":\"2024-07-23T13:28:32.578Z\"}},\"user\":{\"id\":\"2222222222222222222222\",\"email\":\"john.doe@example.com\",\"firstName\":\"John\",\"lastName\":\"Doe\",\"jobTitle\":null,\"phoneNumber\":null,\"language\":\"English\",\"isDeactivated\":false,\"isFirstConnection\":true,\"toNotify\":false,\"lastConnectionDate\":\"2024-07-23T14:56:26.000Z\",\"creationDate\":\"2024-07-03T12:24:48.924Z\",\"lastModificationDate\":\"2024-07-23T14:56:26.000Z\"},\"device\":null,\"company\":{\"id\":\"3333333333333333333333\",\"name\":\"Mobile boat\",\"creationDate\":\"2024-07-03T10:01:02.043Z\",\"lastModificationDate\":\"2024-07-04T07:19:50.000Z\",\"deletedAt\":null}}",
        "event": {
...
=== "device-application-compliance-updated.json"
...
=== "device-compliance-new.json"

    ```json
	
    {
        "message": "{\"id\": \"1111111111111111111111\", \"deviceCompliance\": {\"id\": \"2222222222222222222222\", \"status\": \"Approved\", \"computed\": true, \"creationDate\": \"2026-08-26T11:17:38.199Z\", \"lastModificationDate\": \"2026-08-26T11:17:39.000Z\", \"device\": {\"id\": \"3333333333333333333333\", \"serialNumber\": null, \"imei\": null, \"name\": null, \"email\": null, \"byod\": false, \"lockPassword\": null, \"knoxVersion\": null, \"declaredOperatingSystem\": \"Android\", \"declaredOperatingSystemVersion\": \"13.0\", \"declaredOperatingSystemSecurityPatchDate\": null, \"declaredModel\": null, \"riskyAppsNotificationPendingAt\": null, \"group\": {\"id\": \"4444444444444444444444\", \"name\": \"Android Entreprise\", \"createdAt\": \"2026-03-26T14:29:55.000Z\", \"emmGroupInfo\": {\"id\": \"5555555555555555555555\", \"externalId\": \"337\", \"metadata\": null, \"lastSynchronizationDate\": \"2026-08-26T11:00:00.000Z\"}, \"detectionPolicy\": {\"id\": \"11111111111111111111111111111111111111111111\", \"name\": \"Standard\", \"type\": \"Application and device threat\", \"creationDate\": \"2026-01-15T17:51:33.606Z\", \"lastModificationDate\": \"2026-08-20T17:22:18.000Z\", \"inheritable\": true, \"version\": 5, \"7777777777777777777777\": 2, \"malwarePredictionStatusLevel\": \"Red\"}}, \"enrollmentStatus\": {\"id\": \"8888888888888888888888\", \"lastConnection\": null, \"coupled\": false, \"versionCode\": null, \"configuration\": null, \"raspId\": null}, \"emmDeviceInfo\": {\"id\": \"9999999999999999999999\", \"externalId\": \"11111111-1111-1111-1111-111111111111\", \"integration\": {\"id\": \"10101010101010101010101010101010101010101010\", \"emm\": \"mobile_iron\", \"name\": null, \"creationDate\": \"2026-03-18T14:01:30.369Z\", \"lastModificationDate\": \"2026-03-18T14:01:30.369Z\", \"active\": true, \"jobs\": \"updateGroups,updateDevices,updateApplications,updateLabels,cleanGroups,cleanDevices\", \"settings\": null, \"options\": {\"filters\": [337], \"filterBy\": \"label\", \"labels\": {\"prefix\": \"[Pradeo-EXAMPLE]\", \"rules\": [{\"global\": true, \"tags\": []}]}, \"testDevices\": [], \"fieldsMap\": {\"USER_EMAIL\": \"not overwritten\", \"user_name\": \"not overwritten\"}, \"defaultDetectionPolicy\": \"11111111111111111111111111111111111111111111\"}}, \"metadata\": {\"deviceOwnershipCriteria\": \"owner = COMPANY\"}, \"lastSynchronizationDate\": \"2026-08-26T11:00:00.000Z\"}}, \"matchedResponseRules\": [{\"id\": \"12121212121212121212121212121212121212121212\", \"matchConditions\": [{\"type\": \"enrollmentStatusIs\", \"value\": \"unenrolled\", \"detectedOn\": [\"professional\"]}], \"notifyAdministrator\": true, \"onDeviceNotification\": true, \"action\": \"NotDefined\", \"responseRuleset\": {\"id\": \"13131313131313131313131313131313131313131313\", \"name\": \"Globally enforced\", \"active\": true, \"type\": \"GloballyEnforced\", \"priority\": 0}, \"priority\": 1}]}}",
        "event": {
            "category": [
                "process"
            ],
        ...
        "pradeo": {
            "compliance": {
                "matchedResponseRules": [
                    {
                        "action": "NotDefined",
                        "id": "12121212121212121212121212121212121212121212",
                        "matchConditions": [
                            {
                                "detectedOn": [
                                    "professional"
                                ],
                                "type": "enrollmentStatusIs",
                                "value": "unenrolled"
                            }
                        ],
                        "notifyAdministrator": true,
                        "onDeviceNotification": true,
                        "priority": 1,
                        "responseRuleset": {
                            "active": true,
                            "id": "13131313131313131313131313131313131313131313",
                            "name": "Globally enforced",
                            "priority": 0,
            ...
            "device": {
                ...
                "coupled": false,
                "declaredOperatingSystem": "Android",
                "declaredOperatingSystemVersion": "13.0",
                "id": "3333333333333333333333",
                "mdmId": "11111111-1111-1111-1111-111111111111"
            },
            "metadata": {
                "creationDate": "2026-08-26T11:17:38.199000Z",
...
=== "test_new_event_6.json"
    ...
    {
        "message": "{\n  \"id\": \"00000000-0000-0000-0000-000000000000\",\n  \"integration\": {\n    \"id\": \"11111111-1111-1111-1111-111111111111\",\n    \"company\": {\n      \"id\": \"22222222-2222-2222-2222-222222222222\",\n      \"name\": \"EXAMPLE\",\n      \"creationDate\": \"2024-08-07T07:08:28.955Z\",\n      \"lastModificationDate\": \"2026-03-24T15:24:35.000Z\",\n      \"defaultDetectionPolicy\": {\n        \"id\": \"33333333-3333-3333-3333-333333333333\",\n        \"name\": \"Example Detection Policy\",\n        \"type\": \"Application and device threat\",\n        \"creationDate\": \"2024-09-11T09:02:40.703Z\",\n        \"lastModificationDate\": \"2025-12-09T09:53:54.000Z\",\n        \"inheritable\": true,\n        \"version\": 4,\n        \"antivirusScanThreshold\": 3,\n        \"malwarePredictionStatusLevel\": \"Orange\"\n      },\n      \"deletedAt\": null\n    },\n    \"emm\": \"airwatch\",\n    \"name\": null,\n    \"creationDate\": \"2024-08-07T09:04:18.433Z\",\n    \"lastModificationDate\": \"2025-08-12T09:42:28.000Z\",\n    \"active\": true,\n    \"jobs\": \"updateGroups,updateDevices,updateApplications,updateTags,cleanDevices\",\n    \"settings\": null,\n    \"options\": {\n      \"purge\": {\n        \"onlyEnrolledOnPradeo\": {\n          \"delete\": null,\n          \"unenroll\": null\n        },\n        \"unEnrolled\": {\n          \"delete\": null,\n          \"unenroll\": null\n        },\n        \"deviceWipePending\": {\n          \"delete\": null,\n          \"unenroll\": null\n        },\n        \"enterpriseWipePending\": {\n          \"delete\": null,\n          \"unenroll\": null\n        }\n      },\n      \"timeBetweenPradeoAndAirwatchLastConnections\": 2,\n      \"denyLists\": {\n        \"android\": {\n          \"airwatchAppGroupId\": null,\n          \"appGroupDescription\": \"Risk Management policy for apps with malicious behaviors.\",\n          \"appGroupName\": \"Blacklist Apps ANDROID\"\n        },\n        \"ios\": {\n          \"airwatchAppGroupId\": null,\n          \"appGroupDescription\": \"Risk Management policy for apps with malicious behaviors.\",\n          \"appGroupName\": \"Blacklist Apps IOS\"\n        },\n        \"policy\": null\n      },\n      \"organizationGroupIdList\": [\n        12291,\n        12314,\n        12315,\n        12821,\n        12972,\n        13033,\n        14374,\n        13036\n      ],\n      \"organizationGroupIdListBehavior\": \"including\",\n      \"tags\": [\n        {\n          \"global\": true,\n          \"tags\": []\n        }\n      ],\n      \"testDevices\": [],\n      \"synchronizeDenyLists\": true,\n      \"fieldsMap\": {\n        \"USER_EMAIL\": \"not overwritten\",\n        \"user_name\": \"DeviceFriendlyName\"\n      },\n      \"defaultDetectionPolicy\": \"44444444-4444-4444-4444-444444444444\"\n    }\n  },\n  \"job\": \"updateDevices\",\n  \"synchronizedEntities\": 0,\n  \"lastSynchronizationDate\": \"2026-07-21T08:13:58.000Z\",\n  \"error\": \"A problem has occurred. For more information, please contact Pradeo support.\"\n}",
        "event": {
            "category": [
                "process"
            ],
        ...
        "@timestamp": "2026-07-21T08:13:58Z",
        "error": {
            "message": "A problem has occurred. For more information, please contact Pradeo support."
        },
        "pradeo": {
            "device": {
                "emm": "airwatch",
            ...
            "metadata": {
                "creationDate": "2024-08-07T09:04:18.433000Z",
                "id": "00000000-0000-0000-0000-000000000000"
            },
            "policy": {
                "id": "33333333-3333-3333-3333-333333333333",
...
|`pradeo.device.is_active` | `boolean` | active state of the device |
|`pradeo.device.jobs` | `array` | jobs of the device |
