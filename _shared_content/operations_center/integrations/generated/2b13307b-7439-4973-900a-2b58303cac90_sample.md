...
=== "PROCESS_DOMAIN_USERNAME"

    ```
	[Originator@6876 sub=Libs opID=esxcli-0d-aaaa sid=11111111 user=domain\username] Util: ForkExec(/usr/lib/vmware/openssh/bin/sshd ++group=hostd-tmp,mem=120 -t -f /etc/ssh/sshd_config ) 2222222
    ```
...
=== "SNAPSHOT_with_effective_user"

    ```
	info hostd[12345] [Originator@6876 sub=Vmsvc.vm:/vmfs/volumes/00000000-11111111/VMNAME01/VMNAME01.vmx opID=mjag6ln1-6096236-auto-3mnvx-h5:70899704-f0-61-496e sid=52f88934 user=vpxuser:EXAMPLE\adm2_jbauchene] Create Snapshot: Snapshot de VM 10/02/2026 16:28:55, memory=false, quiescent=false state=5
    ```



=== "SNAPSHOT_with_service_account"

    ```
	info hostd[12345] [Originator@6876 sub=Vmsvc.vm:/vmfs/volumes/00000000-11111111/VMNAME02/VMNAME02.vmx opID=60608c87-61-066f sid=528c86c8 user=vpxuser:EXAMPLE\svc_vcenter_evault] Create Snapshot: vSphere Snapshot, memory=false, quiescent=true state=5
    ```
