...
=== "banned.json"
	...
	
    {
        ...
        "url": {
            ...
            "original": "https://example.com/%2F%2F/%2F%2F/%2F%2F/etc/passwd",
            "path": "/%2F%2F/%2F%2F/%2F%2F/etc/passwd",
            "port": 443,
            "registered_domain": "example.com",
            "scheme": "https",
            "top_level_domain": "com"
...
|`ogo.credibility` | `number` | Credibility rating of the request. Once dropped below the acceptability threshold of the cluster (or of the site if overloaded by Expert mode), the IP is temporarily banned. |
