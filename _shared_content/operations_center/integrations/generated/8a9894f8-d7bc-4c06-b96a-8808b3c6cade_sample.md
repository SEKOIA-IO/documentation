...
=== "test_failed_attempts_3"
    ...
    ```
	CISE_Failed_Attempts 0000815085 5 4 IPSEC=IPSEC#Is IPSEC Device#No, Name=Endpoint Identity Groups:Profiled, Response={RadiusPacketType=AccessReject; AuthenticationResult=Passed; UserName=12:22:33:44:55:66; },#15
    ```
...
=== "test_mab_username_is_mac"

    ```
	CISE_Passed_Authentications 0000815090 6 5 NetworkDeviceName=switch01, UserName=02:1a:2b:3c:4d:5e, SelectedAuthenticationIdentityStores=Internal Endpoints,#15
    ```



=== "test_mab_username_is_mac_auth_status"

    ```
	CISE_Passed_Authentications 0000815091 6 5 UserName=aa:bb:cc:dd:ee:ff, AuthenticationStatus=AuthenticationPassed, NetworkDeviceName=switch02,#15
    ```
