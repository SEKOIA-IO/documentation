	...
	
    {
        ...
        "deepvisibility": {
            ...
            "process": {
                ...
                "executable": {
                    "name": "C:\\Windows\\System32\\sdiagnhost.exe"
                },
                "family": "SYS_WIN32",
        ...
        "file": {
            ...
            "size": 76,
            "created": "1966-04-24T06:14:24.000000Z",
            "mtime": "1966-04-24T06:14:24.000000Z",
            "code_signature": {
                "exists": false
            }
        },
        "related": {
            "hash": [
                ...
                "9b77e09375790ea1ea0a9ca9fc1d69e8e32fe597",
                "a00bf82660835224cd6606a248321c5d",
                "e5ec6b5b20a16383cc953ad5e478dcdf95ba46281f4fe971673c954d4145c0c4",
                "e610d62f73d68a280d364d1ccd6fea30",
                "e63709209d09bc0247e785f075ddb28a98c348206109e2b8ba321ad958402728"
            ],
            "user": [
                "desktop-jdoe\\john.doe"
            ]
        }
    }
	...
	
    {
        ...
        "related": {
            "hash": [
                ...
                "5310ba14a05256e4d93e0b04338f53b4e1d680cb",
                "8ee21a0ba8849d31c265b4090a9e2ebe8ba66f58a8f71d4e96509e8a78f7db00",
                "a21e7719d73d0322e2e7d61802cb8f80",
	...
	
    {
        ...
        "deepvisibility": {
            ...
            "process": {
                ...
                "executable": {
                    "name": "C:\\WindowsAzure\\GuestAgent_2.7.41491.1075_2023-03-16_134252\\WindowsAzureGuestAgent.exe"
                },
                "family": "SYS_WIN32",
                "integrity_level": "SYSTEM",
                "is_redirected_command_processor": "False",
	...
	
    {
        ...
        "deepvisibility": {
            ...
            "process": {
                ...
                "executable": {
                    "name": "C:\\WindowsAzure\\GuestAgent_2.7.41491.1075_2023-03-16_134252\\CollectGuestLogs.exe"
                },
                "family": "SYS_WIN32",
                "integrity_level": "SYSTEM",
                "is_redirected_command_processor": "False",
	...
	
    {
        ...
        "deepvisibility": {
            ...
            "process": {
                ...
                "executable": {
                    "name": "C:\\Packages\\Plugins\\Microsoft.Azure.Security.WindowsAttestation.GuestAttestation\\1.0.1.21\\AttestationClient.exe"
                },
                "family": "SYS_WIN32",
                "integrity_level": "SYSTEM",
                "is_redirected_command_processor": "False",
                ...
                "parent": {
                    ...
                    "executable": {
                        "name": "C:\\Packages\\Plugins\\Microsoft.Azure.Security.WindowsAttestation.GuestAttestation\\1.0.1.21\\AttestationExtension.exe"
                    },
                    "family": "SYS_WIN32",
                    "integrity_level": "SYSTEM",
                    "is_redirected_command_processor": "False",
	...
	
    {
        ...
        "deepvisibility": {
            ...
            "process": {
                ...
                "executable": {
                    "name": "C:\\Windows\\System32\\wevtutil.exe"
                },
                "family": "SYS_WIN32",
                "integrity_level": "SYSTEM",
                "is_redirected_command_processor": "False",
...
=== "scheduledtask_taskregister.json"
	...
	
    {
        ...
        "related": {
            "hash": [
                "08a3589a9016172702c75f16fe3c694b90942514",
                "3519db09c7d58615c5a5a8ef508e163e63ecb428f113021e0e3cd47fb7f39c9e",
                "4a8b68a1ad588175d018944aacca6151e2cb4e3c",
                "5ad6cf448d3492310e89ab0ce7f7230f93b359fec8314a3e2b22084fbe24d4d8",
                "b5da026b38c9e98a6f6d4061b6c3b4f3",
                "cdbae87d50068565cf2ed20e99246a2e"
            ],
            "user": [
                "desktop-jdoe\\john.doe"
            ]
...
|`action.properties.TargetDomainName` | `keyword` | The type of the Logon |
|`action.properties.TargetUserName` | `keyword` | The type of the Logon |
|`action.properties.TargetUserSid` | `keyword` | The type of the Logon |
...
|`deepvisibility.process.ossrc.code_signature.exists` | `keyword` |  |
|`deepvisibility.process.ossrc.code_signature.status` | `keyword` |  |
|`deepvisibility.process.ossrc.code_signature.subject_name` | `keyword` |  |
|`deepvisibility.process.ossrc.code_signature.valid` | `keyword` |  |
|`deepvisibility.process.ossrc.command_line` | `keyword` |  |
...
|`deepvisibility.process.ossrc.executable` | `keyword` |  |
|`deepvisibility.process.ossrc.family` | `keyword` |  |
|`deepvisibility.process.ossrc.hash.md5` | `keyword` |  |
|`deepvisibility.process.ossrc.hash.sha1` | `keyword` |  |
|`deepvisibility.process.ossrc.hash.sha256` | `keyword` |  |
...
|`deepvisibility.process.ossrc.name` | `keyword` |  |
...
|`deepvisibility.process.ossrc.parent.code_signature.exists` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.code_signature.status` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.code_signature.subject_name` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.code_signature.valid` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.command_line` | `keyword` |  |
...
|`deepvisibility.process.ossrc.parent.executable` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.family` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.hash.md5` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.hash.sha1` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.hash.sha256` | `keyword` |  |
...
|`deepvisibility.process.ossrc.parent.name` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.process.pid` | `long` |  |
|`deepvisibility.process.ossrc.parent.process.start` | `date` |  |
...
|`deepvisibility.process.ossrc.parent.title` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.uid` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.user.name` | `keyword` |  |
|`deepvisibility.process.ossrc.parent.working_directory` | `keyword` |  |
|`deepvisibility.process.ossrc.process.pid` | `long` |  |
|`deepvisibility.process.ossrc.process.start` | `date` |  |
...
|`deepvisibility.process.ossrc.title` | `keyword` |  |
|`deepvisibility.process.ossrc.uid` | `keyword` |  |
|`deepvisibility.process.ossrc.user.name` | `keyword` |  |
|`deepvisibility.process.ossrc.working_directory` | `keyword` |  |
