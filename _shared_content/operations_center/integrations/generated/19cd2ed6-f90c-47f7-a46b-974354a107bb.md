...
=== "add_member_to_group_2.json"
	...
	
    {
        ...
        "user": {
            ...
            "full_name": "Microsoft Teams Services",
            "id": "user1",
            "name": "user1",
            "target": {
                "group": {
...
=== "change_password.json"
    ...
    {
        "message": "{\"time\":\"2026-03-01T15:06:06.0363302Z\",\"resourceId\":\"/tenants/11111111-1111-1111-1111-111111111111/providers/Microsoft.aadiam\",\"operationName\":\"Change password (self-service)\",\"operationVersion\":\"1.0\",\"category\":\"AuditLogs\",\"tenantId\":\"11111111-1111-1111-1111-111111111111\",\"resultSignature\":\"None\",\"resultDescription\":\"On-premises operation result: ChangeSuccess. Cloud operation result: Unknown\",\"durationMs\":0,\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"identity\":\"My Signins\",\"level\":\"Informational\",\"properties\":{\"category\":\"UserManagement\",\"id\":\"SSPR_22222222-2222-2222-2222-222222222222_AAAAA_22222222\",\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"result\":\"failure\",\"resultReason\":\"On-premises operation result: ChangeSuccess. Cloud operation result: Unknown\",\"activityDisplayName\":\"Change password (self-service)\",\"activityDateTime\":\"2026-03-01T15:06:06.0363302Z\",\"loggedByService\":\"Self-service Password Management\",\"operationType\":\"Update\",\"userAgent\":\"\",\"initiatedBy\":{\"user\":{\"id\":\"33333333-3333-3333-3333-333333333333\",\"displayName\":null,\"userPrincipalName\":\"John.DOE@example.com\",\"ipAddress\":\"\",\"roles\":[],\"userType\":\"Member\",\"agentType\":\"notAgentic\"},\"app\":{\"appId\":\"44444444-4444-4444-4444-444444444444\",\"displayName\":\"My Signins\",\"servicePrincipalId\":null,\"servicePrincipalName\":null,\"agentType\":\"notAgentic\",\"blueprintId\":null}},\"additionalDetails\":[{\"key\":\"ErrorMessage\",\"value\":\"\"},{\"key\":\"OnPremisesAgent\",\"value\":\"AADConnect\"}],\"targetResources\":[{\"id\":\"33333333-3333-3333-3333-333333333333\",\"displayName\":null,\"type\":\"User\",\"userPrincipalName\":\"John.DOE@example.com\",\"modifiedProperties\":[],\"administrativeUnits\":[],\"agentType\":\"notAgentic\"}]}}",
        "event": {
            "action": "Change password (self-service)",
            "category": [
                "iam"
            ],
            "outcome": "failure",
        ...
        "action": {
            ...
            "outcome": "failure",
            "outcome_reason": "On-premises operation result: ChangeSuccess. Cloud operation result: Unknown",
            "properties": [
                {
                    "id": "33333333-3333-3333-3333-333333333333",
        ...
        "azuread": {
            ...
            "properties": {
                ...
                "targetUserPrincipalName": "John.DOE@example.com"
            },
            "resourceId": "/tenants/11111111-1111-1111-1111-111111111111/providers/Microsoft.aadiam",
	...
	
    {
        ...
        "azuread": {
            ...
            "properties": {
                ...
                "identityType": "user",
                "issuedAt": "2025-02-18T10:20:11.000000Z",
	...
	
    {
        ...
        "azuread": {
            ...
            "properties": {
                ...
                "identityType": "user",
                "issuedAt": "2025-10-02T08:45:25.000000Z",
                ...
                "security_identifier": "11111111-1111-1111-1111-111111111111",
...
=== "graph_activity_3.json"

    ```json
	
    {
        "message": "{\"time\":\"2026-04-21T22:02:48.8644399Z\",\"resourceId\":\"/TENANTS/11111111-1111-1111-1111-111111111111/PROVIDERS/MICROSOFT.AADIAM\",\"operationName\":\"Microsoft Graph Activity\",\"operationVersion\":\"v1.0\",\"category\":\"MicrosoftGraphActivityLogs\",\"resultSignature\":\"404\",\"durationMs\":\"53501296\",\"callerIpAddress\":\"1.2.3.4\",\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"level\":\"Informational\",\"location\":\"France\",\"properties\":{\"__UDI_RequiredFields_TenantId\":\"11111111-1111-1111-1111-111111111111\",\"__UDI_RequiredFields_UniqueId\":\"22222222-2222-2222-2222-222222222222\",\"__UDI_RequiredFields_EventTime\":639124057688644399,\"__UDI_RequiredFields_RegionScope\":\"EU\",\"timeGenerated\":\"2026-04-21T22:02:48.8644399Z\",\"location\":\"France\",\"requestId\":\"22222222-2222-2222-2222-222222222222\",\"operationId\":\"22222222-2222-2222-2222-222222222222\",\"clientRequestId\":\"22222222-2222-2222-2222-222222222222\",\"apiVersion\":\"v1.0\",\"requestMethod\":\"GET\",\"responseStatusCode\":404,\"tenantId\":\"11111111-1111-1111-1111-111111111111\",\"durationMs\":53501296,\"responseSizeBytes\":300,\"signInActivityId\":\"s3-111111111111111111\",\"roles\":\"\",\"appId\":\"33333333-3333-3333-3333-333333333333\",\"UserPrincipalObjectID\":\"44444444-4444-4444-4444-444444444444\",\"scopes\":\"AuditLog.Create Calendar.ReadWrite Calendars.Read.Shared Calendars.ReadWrite Channel.Create Channel.ReadBasic.All ChannelMember.ReadWrite.All ChannelMessage.Read.All ChannelMessage.Send ChannelSettings.ReadWrite.All Chat.Create Chat.ReadWrite ChatMember.ReadWrite Contacts.ReadWrite DataLossPreventionPolicy.Evaluate Directory.AccessAsUser.All Directory.Read.All email Files.Read Files.Read.All Files.ReadWrite.All FileStorageContainer.Selected Group.Read.All Group.ReadWrite.All InformationProtectionPolicy.Read Mail.ReadWrite Mail.Send Notes.Create openid Organization.Read.All People.Read People.Read.All Printer.Read.All PrinterShare.ReadBasic.All PrintJob.Create PrintJob.ReadWriteBasic profile Reports.Read.All SensitiveInfoType.Detect SensitiveInfoType.Read.All SensitivityLabel.Evaluate Tasks.ReadWrite Team.ReadBasic.All TeamMember.ReadWrite.All TeamsTab.ReadWriteForChat User.Read.All User.ReadBasic.All User.ReadWrite Users.Read\",\"identityProvider\":\"\",\"clientAuthMethod\":\"0\",\"wids\":\"55555555-5555-5555-5555-555555555555\",\"C_Idtyp\":\"user\",\"C_Iat\":\"1776808657\",\"ipAddress\":\"1.2.3.4\",\"userAgent\":\"Microsoft Office/16.0 (Windows NT 10.0; Microsoft Outlook 16.0.19822; Pro)\",\"requestUri\":\"https://graph.microsoft.com/v1.0/users/john.doe@company.com/photo/$value\",\"atContentP\":\"\",\"atContentH\":\"\",\"C_Sid\":\"66666666-6666-6666-6666-666666666666\",\"C_DeviceId\":\"77777777-7777-7777-7777-777777777777\",\"policyEvaluated\":false,\"userId\":\"44444444-4444-4444-4444-444444444444\",\"tokenIssuedAt\":\"2026-04-21T21:57:37.0000000Z\"},\"tenantId\":\"11111111-1111-1111-1111-111111111111\"}",
        "event": {
            "action": "Microsoft Graph Activity",
            "category": [
                "iam"
        ...
        "azuread": {
            ...
            "properties": {
                ...
                "identityType": "user",
                "issuedAt": "2026-04-21T21:57:37.000000Z",
                ...
                "security_identifier": "66666666-6666-6666-6666-666666666666",
                "session_id": "66666666-6666-6666-6666-666666666666",
                "uniqueTokenIdentifier": "s3-111111111111111111",
        ...
        "url": {
            ...
            "full": "https://graph.microsoft.com/v1.0/users/john.doe@company.com/photo/$value",
            "original": "https://graph.microsoft.com/v1.0/users/john.doe@company.com/photo/$value",
            "path": "/v1.0/users/john.doe@company.com/photo/$value",
            "port": 443,
        ...
        "user_agent": {
            ...
            "name": "Outlook",
            "original": "Microsoft Office/16.0 (Windows NT 10.0; Microsoft Outlook 16.0.19822; Pro)",
            "os": {
                "name": "Windows",
                "version": "10"
            },
...
=== "graph_activity_4.json"

    ```json
	
    {
        "message": "{\"time\":\"2026-04-21T22:02:48.8644399Z\",\"resourceId\":\"/TENANTS/11111111-1111-1111-1111-111111111111/PROVIDERS/MICROSOFT.AADIAM\",\"operationName\":\"Microsoft Graph Activity\",\"operationVersion\":\"v1.0\",\"category\":\"MicrosoftGraphActivityLogs\",\"resultSignature\":\"404\",\"durationMs\":\"53501296\",\"callerIpAddress\":\"1.2.3.4\",\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"level\":\"Informational\",\"location\":\"France\",\"properties\":{\"__UDI_RequiredFields_TenantId\":\"11111111-1111-1111-1111-111111111111\",\"__UDI_RequiredFields_UniqueId\":\"22222222-2222-2222-2222-222222222222\",\"__UDI_RequiredFields_EventTime\":639124057688644399,\"__UDI_RequiredFields_RegionScope\":\"EU\",\"timeGenerated\":\"2026-04-21T22:02:48.8644399Z\",\"location\":\"France\",\"requestId\":\"22222222-2222-2222-2222-222222222222\",\"operationId\":\"22222222-2222-2222-2222-222222222222\",\"clientRequestId\":\"22222222-2222-2222-2222-222222222222\",\"apiVersion\":\"v1.0\",\"requestMethod\":\"GET\",\"responseStatusCode\":404,\"tenantId\":\"11111111-1111-1111-1111-111111111111\",\"durationMs\":53501296,\"responseSizeBytes\":300,\"signInActivityId\":\"s3-1111111111111111111\",\"roles\":\"\",\"appId\":\"33333333-3333-3333-3333-333333333333\",\"UserPrincipalObjectID\":\"44444444-4444-4444-4444-444444444444\",\"scopes\":\"AuditLog.Create Calendar.ReadWrite Calendars.Read.Shared Calendars.ReadWrite Channel.Create Channel.ReadBasic.All ChannelMember.ReadWrite.All ChannelMessage.Read.All ChannelMessage.Send ChannelSettings.ReadWrite.All Chat.Create Chat.ReadWrite ChatMember.ReadWrite Contacts.ReadWrite DataLossPreventionPolicy.Evaluate Directory.AccessAsUser.All Directory.Read.All email Files.Read Files.Read.All Files.ReadWrite.All FileStorageContainer.Selected Group.Read.All Group.ReadWrite.All InformationProtectionPolicy.Read Mail.ReadWrite Mail.Send Notes.Create openid Organization.Read.All People.Read People.Read.All Printer.Read.All PrinterShare.ReadBasic.All PrintJob.Create PrintJob.ReadWriteBasic profile Reports.Read.All SensitiveInfoType.Detect SensitiveInfoType.Read.All SensitivityLabel.Evaluate Tasks.ReadWrite Team.ReadBasic.All TeamMember.ReadWrite.All TeamsTab.ReadWriteForChat User.Read.All User.ReadBasic.All User.ReadWrite Users.Read\",\"identityProvider\":\"\",\"clientAuthMethod\":\"0\",\"wids\":\"55555555-5555-5555-5555-555555555555\",\"C_Idtyp\":\"user\",\"C_Iat\":\"1776808657\",\"ipAddress\":\"1.2.3.4\",\"userAgent\":\"Microsoft Office/16.0 (Windows NT 10.0; Microsoft Outlook 16.0.19822; Pro)\",\"requestUri\":\"https://graph.microsoft.com/v1.0/users/john_doe@company.com/photo/$value\",\"atContentP\":\"\",\"atContentH\":\"\",\"C_Sid\":\"66666666-6666-6666-6666-666666666666\",\"C_DeviceId\":\"77777777-7777-7777-7777-777777777777\",\"policyEvaluated\":false,\"userId\":\"44444444-4444-4444-4444-444444444444\",\"tokenIssuedAt\":\"2026-04-21T21:57:37.0000000Z\"},\"tenantId\":\"11111111-1111-1111-1111-111111111111\"}",
        "event": {
            "action": "Microsoft Graph Activity",
            "category": [
                "iam"
        ...
        "azuread": {
            ...
            "properties": {
                ...
                "security_identifier": "66666666-6666-6666-6666-666666666666",
                "session_id": "66666666-6666-6666-6666-666666666666",
                "uniqueTokenIdentifier": "s3-1111111111111111111",
                "userPrincipalObjectID": "44444444-4444-4444-4444-444444444444"
            },
            "resourceId": "/TENANTS/11111111-1111-1111-1111-111111111111/PROVIDERS/MICROSOFT.AADIAM",
            "resultSignature": "404",
        ...
        "url": {
            "domain": "graph.microsoft.com",
            "full": "https://graph.microsoft.com/v1.0/users/john_doe@company.com/photo/$value",
            "original": "https://graph.microsoft.com/v1.0/users/john_doe@company.com/photo/$value",
            "path": "/v1.0/users/john_doe@company.com/photo/$value",
            "port": 443,
            "registered_domain": "microsoft.com",
            "scheme": "https",
            "subdomain": "graph",
...
=== "sign-in_activity3.json"
	...
	
    {
        ...
        "@timestamp": "2023-08-16T15:28:23.304593Z",
        "action": {
            "name": "Sign-in activity",
            "outcome": "success"
        },
...
=== "sign-in_activity4.json"
	...
	
    {
        ...
        "@timestamp": "2023-10-04T13:06:18.961719Z",
        "action": {
            "name": "Sign-in activity",
            "outcome": "success"
        },
...
=== "sign-in_activity5.json"
	...
	
    {
        ...
        "@timestamp": "2025-02-17T08:35:37.654480Z",
        "action": {
            "name": "Sign-in activity",
            "outcome": "success"
        },
...
=== "sign-in_activity6.json"
	...
	
    {
        ...
        "@timestamp": "2025-07-24T15:30:17.797441Z",
        "action": {
            "name": "Sign-in activity",
            "outcome": "success"
        },
...
=== "sign-in_activity8.json"
	...
	
    {
        ...
        "event": {
            ...
            "outcome": "failure",
            "reason": "The account is locked, you've tried to sign in too many times with an incorrect user ID or password.",
            "type": [
                "start"
            ]
        },
        "@timestamp": "2026-05-17T03:42:49.402236Z",
        "action": {
            "name": "Sign-in activity",
            "outcome": "failure"
        },
...
=== "update_policy.json"
    ...
    {
        "message": "{\"time\":\"2026-04-16T07:23:27.5861501Z\",\"resourceId\":\"/tenants/11111111-1111-1111-1111-111111111111/providers/Microsoft.aadiam\",\"operationName\":\"Update conditional access policy\",\"operationVersion\":\"1.0\",\"category\":\"AuditLogs\",\"tenantId\":\"11111111-1111-1111-1111-111111111111\",\"resultSignature\":\"None\",\"durationMs\":0,\"callerIpAddress\":\"1.2.3.4\",\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"identity\":\"John DOE Global Admin\",\"level\":\"Informational\",\"properties\":{\"category\":\"Policy\",\"id\":\"ID_22222222-2222-2222-2222-222222222222_22222_22222222\",\"correlationId\":\"22222222-2222-2222-2222-222222222222\",\"result\":\"success\",\"resultReason\":\"\",\"activityDisplayName\":\"Update conditional access policy\",\"activityDateTime\":\"2026-04-16T07:23:27.5861501Z\",\"loggedByService\":\"Conditional Access\",\"operationType\":\"Update\",\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0\",\"initiatedBy\":{\"user\":{\"id\":\"33333333-3333-3333-3333-333333333333\",\"displayName\":\"John DOE Global Admin\",\"userPrincipalName\":\"john.doe-admin@example.com\",\"ipAddress\":\"1.2.3.4\",\"roles\":[],\"userType\":\"Member\",\"agentType\":\"notAgentic\"},\"app\":{\"appId\":\"44444444-4444-4444-4444-444444444444\",\"displayName\":\"Redacted\",\"servicePrincipalId\":null,\"servicePrincipalName\":null,\"agentType\":\"notAgentic\",\"blueprintId\":null}},\"additionalDetails\":[{\"key\":\"Category\",\"value\":\"Conditional Access\"}],\"targetResources\":[{\"id\":\"55555555-5555-5555-5555-555555555555\",\"displayName\":\"[Test integration] Display name\",\"type\":\"Policy\",\"modifiedProperties\":[{\"displayName\":\"ConditionalAccessPolicy\",\"oldValue\":\"{\\\"id\\\":\\\"55555555-5555-5555-5555-555555555555\\\",\\\"displayName\\\":\\\"[Test integration] Display name\\\",\\\"createdDateTime\\\":\\\"2024-02-16T14:55:35.7799436+00:00\\\",\\\"modifiedDateTime\\\":\\\"2026-04-16T07:13:51.7195747+00:00\\\",\\\"state\\\":\\\"enabled\\\",\\\"conditions\\\":{\\\"applications\\\":{\\\"includeApplications\\\":[\\\"All\\\"],\\\"excludeApplications\\\":[],\\\"includeUserActions\\\":[],\\\"includeAuthenticationContextClassReferences\\\":[],\\\"applicationFilter\\\":null},\\\"users\\\":{\\\"includeUsers\\\":[],\\\"excludeUsers\\\":[\\\"66666666-6666-6666-6666-666666666666\\\",\\\"77777777-7777-7777-7777-777777777777\\\"],\\\"includeGroups\\\":[\\\"88888888-8888-8888-8888-888888888888\\\",\\\"99999999-9999-9999-9999-999999999999\\\"],\\\"excludeGroups\\\":[\\\"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa\\\"],\\\"includeRoles\\\":[],\\\"excludeRoles\\\":[\\\"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb\\\",\\\"cccccccc-cccc-cccc-cccc-cccccccccccc\\\",\\\"dddddddd-dddd-dddd-dddd-dddddddddddd\\\",\\\"eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee\\\",\\\"ffffffff-ffff-ffff-ffff-ffffffffffff\\\"],\\\"excludeGuestsOrExternalUsers\\\":{\\\"guestOrExternalUserTypes\\\":63,\\\"externalTenants\\\":{}}},\\\"locations\\\":{\\\"includeLocations\\\":[\\\"AllTrusted\\\"],\\\"excludeLocations\\\":[]},\\\"userRiskLevels\\\":[],\\\"signInRiskLevels\\\":[],\\\"clientAppTypes\\\":[\\\"all\\\"],\\\"devices\\\":{\\\"deviceFilter\\\":{\\\"mode\\\":\\\"include\\\",\\\"rule\\\":\\\"device.trustType -eq \\\\\\\"ServerAD\\\\\\\" -or device.trustType -eq \\\\\\\"AzureAD\\\\\\\"\\\"},\\\"includeDeviceStates\\\":null,\\\"excludeDeviceStates\\\":null,\\\"includeDevices\\\":[],\\\"excludeDevices\\\":[]},\\\"servicePrincipalRiskLevels\\\":[]},\\\"grantControls\\\":{\\\"operator\\\":\\\"OR\\\",\\\"builtInControls\\\":[\\\"domainJoinedDevice\\\"],\\\"customAuthenticationFactors\\\":[],\\\"termsOfUse\\\":[]},\\\"sessionControls\\\":{\\\"signInFrequency\\\":{\\\"value\\\":7,\\\"type\\\":\\\"days\\\",\\\"authenticationType\\\":\\\"primaryAndSecondaryAuthentication\\\",\\\"frequencyInterval\\\":\\\"timeBased\\\",\\\"isEnabled\\\":true},\\\"persistentBrowser\\\":{\\\"mode\\\":\\\"never\\\",\\\"isEnabled\\\":true}}}\",\"newValue\":\"{\\\"id\\\":\\\"55555555-5555-5555-5555-555555555555\\\",\\\"displayName\\\":\\\"[Test integration] Display name\\\",\\\"createdDateTime\\\":\\\"2024-02-16T14:55:35.7799436+00:00\\\",\\\"modifiedDateTime\\\":\\\"2026-04-16T07:23:26.9951497+00:00\\\",\\\"state\\\":\\\"enabled\\\",\\\"conditions\\\":{\\\"applications\\\":{\\\"includeApplications\\\":[\\\"All\\\"],\\\"excludeApplications\\\":[],\\\"includeUserActions\\\":[],\\\"includeAuthenticationContextClassReferences\\\":[],\\\"applicationFilter\\\":null},\\\"users\\\":{\\\"includeUsers\\\":[],\\\"excludeUsers\\\":[\\\"66666666-6666-6666-6666-666666666666\\\",\\\"77777777-7777-7777-7777-777777777777\\\",\\\"11111111-2222-3333-4444-555555555555\\\"],\\\"includeGroups\\\":[\\\"88888888-8888-8888-8888-888888888888\\\",\\\"99999999-9999-9999-9999-999999999999\\\"],\\\"excludeGroups\\\":[\\\"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa\\\"],\\\"includeRoles\\\":[],\\\"excludeRoles\\\":[\\\"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb\\\",\\\"cccccccc-cccc-cccc-cccc-cccccccccccc\\\",\\\"dddddddd-dddd-dddd-dddd-dddddddddddd\\\",\\\"eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee\\\",\\\"ffffffff-ffff-ffff-ffff-ffffffffffff\\\"],\\\"excludeGuestsOrExternalUsers\\\":{\\\"guestOrExternalUserTypes\\\":63,\\\"externalTenants\\\":{}}},\\\"locations\\\":{\\\"includeLocations\\\":[\\\"AllTrusted\\\"],\\\"excludeLocations\\\":[]},\\\"userRiskLevels\\\":[],\\\"signInRiskLevels\\\":[],\\\"clientAppTypes\\\":[\\\"all\\\"],\\\"devices\\\":{\\\"deviceFilter\\\":{\\\"mode\\\":\\\"include\\\",\\\"rule\\\":\\\"device.trustType -eq \\\\\\\"ServerAD\\\\\\\" -or device.trustType -eq \\\\\\\"AzureAD\\\\\\\"\\\"},\\\"includeDeviceStates\\\":null,\\\"excludeDeviceStates\\\":null,\\\"includeDevices\\\":[],\\\"excludeDevices\\\":[]},\\\"servicePrincipalRiskLevels\\\":[]},\\\"grantControls\\\":{\\\"operator\\\":\\\"OR\\\",\\\"builtInControls\\\":[\\\"domainJoinedDevice\\\"],\\\"customAuthenticationFactors\\\":[],\\\"termsOfUse\\\":[]},\\\"sessionControls\\\":{\\\"signInFrequency\\\":{\\\"value\\\":7,\\\"type\\\":\\\"days\\\",\\\"authenticationType\\\":\\\"primaryAndSecondaryAuthentication\\\",\\\"frequencyInterval\\\":\\\"timeBased\\\",\\\"isEnabled\\\":true},\\\"persistentBrowser\\\":{\\\"mode\\\":\\\"never\\\",\\\"isEnabled\\\":true}}}\"}],\"administrativeUnits\":[],\"agentType\":\"notAgentic\"}]}}",
        "event": {
        ...
        "action": {
            "name": "Update conditional access policy",
            "outcome": "success",
            "properties": [
                {
                ...
                "modified": [
                    {
                        "name": "ConditionalAccessPolicy",
                        "newValue": {
                            "created": "2024-02-16T14:55:35.7799436+00:00",
                            "displayName": "[Test integration] Display name",
                            "id": "55555555-5555-5555-5555-555555555555",
                            "modified": "2026-04-16T07:23:26.9951497+00:00",
                            "state": "enabled"
                        },
                        "oldValue": {
                            "created": "2024-02-16T14:55:35.7799436+00:00",
                            "displayName": "[Test integration] Display name",
                            "id": "55555555-5555-5555-5555-555555555555",
                            "modified": "2026-04-16T07:13:51.7195747+00:00",
                            "state": "enabled"
                        }
                    }
                ]
        ...
        "user": {
            "full_name": "John DOE Global Admin",
            "id": "33333333-3333-3333-3333-333333333333",
        ...
        "user_agent": {
            ...
            "name": "Edge",
            "original": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0",
            "os": {
                "name": "Windows",
                "version": "10"
            },
...
|`azuread.properties.authenticationMethod.code` | `integer` |  |
...
|`azuread.properties.identityType` | `keyword` |  |
|`azuread.properties.incomingTokenType` | `keyword` |  |
|`azuread.properties.issuedAt` | `date` |  |
|`azuread.properties.modified` | `array` |  |
...
|`azuread.properties.security_identifier` | `keyword` |  |
