...
=== "service_account_key_creation.json"

    ```json
	
    {
        "message": "{\"insertId\":\"an7k9zq4v5m1\",\"logName\":\"projects/example-security-prj/logs/cloudaudit.googleapis.com%2Factivity\",\"protoPayload\":{\"@type\":\"type.googleapis.com/google.cloud.audit.AuditLog\",\"authenticationInfo\":{\"oauthInfo\":{\"oauthClientId\":\"900000000000000000001\"},\"principalEmail\":\"111111111111-compute@example.com\",\"principalSubject\":\"serviceAccount:111111111111-compute@example.com\",\"serviceAccountDelegationInfo\":[{\"firstPartyPrincipal\":{\"principalEmail\":\"service-111111111111@example.com\"}}]},\"authorizationInfo\":[{\"granted\":true,\"permission\":\"iam.serviceAccountKeys.create\",\"permissionType\":\"ADMIN_WRITE\",\"resource\":\"projects/-/serviceAccounts/900000000000000000001\",\"resourceAttributes\":{\"name\":\"projects/-/serviceAccounts/900000000000000000001\",\"type\":\"iam.googleapis.com/ServiceAccountKey\"}}],\"methodName\":\"google.iam.admin.v1.CreateServiceAccountKey\",\"request\":{\"@type\":\"type.googleapis.com/google.iam.admin.v1.CreateServiceAccountKeyRequest\",\"name\":\"projects/-/serviceAccounts/111111111111-compute@example.com\",\"private_key_type\":2},\"requestMetadata\":{\"callerIp\":\"203.0.113.193\",\"callerSuppliedUserAgent\":\"google-cloud-sdk gcloud/578.0.0 command/gcloud.iam.service-accounts.keys.create invocation-id/aaaaaaaa11111111bbbbbbbb22222222 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)\",\"destinationAttributes\":{},\"requestAttributes\":{\"auth\":{},\"time\":\"2026-08-04T12:39:51.782103748Z\"}},\"resourceName\":\"projects/-/serviceAccounts/900000000000000000001\",\"response\":{\"@type\":\"type.googleapis.com/google.iam.admin.v1.ServiceAccountKey\",\"key_algorithm\":2,\"key_origin\":2,\"key_type\":1,\"name\":\"projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc\",\"private_key_type\":2,\"valid_after_time\":{\"seconds\":1785847191},\"valid_before_time\":{\"seconds\":253402300799}},\"serviceName\":\"iam.googleapis.com\",\"status\":{}},\"receiveTimestamp\":\"2026-08-04T12:39:52.261534153Z\",\"resource\":{\"labels\":{\"email_id\":\"111111111111-compute@example.com\",\"project_id\":\"example-security-prj\",\"unique_id\":\"900000000000000000001\"},\"type\":\"service_account\"},\"severity\":\"NOTICE\",\"timestamp\":\"2026-08-04T12:39:51.759122942Z\"}",
        "@timestamp": "2026-08-04T12:39:51.759122Z",
        "cloud": {
            "project": {
                "id": "example-security-prj"
            }
        },
        "google_cloud_audit": {
            "insertId": "an7k9zq4v5m1",
            "logName": "projects/example-security-prj/logs/cloudaudit.googleapis.com%2Factivity",
            "protoPayload": {
                "authorizationInfo": [
                    {
                        "granted": true,
                        ...
                        "resource": "projects/-/serviceAccounts/900000000000000000001",
                        "resourceAttributes": {
                            "name": "projects/-/serviceAccounts/900000000000000000001",
                ...
                "requestMetadata": {
                    "requestAttributes": {
                        "time": "2026-08-04T12:39:51.782103748Z"
                    }
                },
                "resourceName": "projects/-/serviceAccounts/900000000000000000001",
                "response": {
                    "name": "projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc",
                    "type": "type.googleapis.com/google.iam.admin.v1.ServiceAccountKey"
                },
                "type": "type.googleapis.com/google.cloud.audit.AuditLog"
            },
            "receiveTimestamp": "2026-08-04T12:39:52.261534153Z",
            "resource": {
                "labels": {
                    "project_id": "example-security-prj"
                },
                "type": "service_account"
            },
            "service_account": {
                "email": "111111111111-compute@example.com",
                "key": {
                    "id": "aaaaaaaa11111111bbbbbbbb22222222cccccccc",
                    "key_algorithm": 2,
                    "key_origin": 2,
                    "key_type": 1,
                    "name": "projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc",
                    "private_key_type": 2,
                    "valid_after_time": 1785847191,
                    "valid_before_time": 253402300799
                }
            },
            "severity": "NOTICE"
        },
        "related": {
            ...
            "user": [
                "111111111111-compute@example.com"
            ]
        },
        "service": {
        ...
        "user": {
            "email": "111111111111-compute@example.com",
            "name": "111111111111-compute@example.com",
            "target": {
                "email": "111111111111-compute@example.com",
                "name": "111111111111-compute@example.com"
            }
        ...
        "user_agent": {
            ...
            "name": "Other",
            "original": "google-cloud-sdk gcloud/578.0.0 command/gcloud.iam.service-accounts.keys.create invocation-id/aaaaaaaa11111111bbbbbbbb22222222 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)",
            "os": {
                "name": "Linux",
                "version": "6.12.74"
            }
...
=== "service_account_key_usage.json"

    ```json
	
    {
        "message": "{\"insertId\":\"k9t2u5c8m3e1\",\"labels\":{\"compute.googleapis.com/root_trigger_id\":\"bbbbbbbb-cccc-4ddd-8eee-ffffffffffff\"},\"logName\":\"projects/example-security-prj/logs/cloudaudit.googleapis.com%2Fdata_access\",\"protoPayload\":{\"@type\":\"type.googleapis.com/google.cloud.audit.AuditLog\",\"apiVersionIdentifier\":\"v1\",\"authenticationInfo\":{\"oauthInfo\":{\"oauthClientId\":\"900000000000000000001\"},\"principalEmail\":\"111111111111-compute@example.com\",\"principalSubject\":\"serviceAccount:111111111111-compute@example.com\",\"serviceAccountKeyName\":\"//iam.googleapis.com/projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc\"},\"authorizationInfo\":[{\"granted\":true,\"permission\":\"compute.instances.list\",\"permissionType\":\"ADMIN_READ\",\"resource\":\"projects/example-security-prj\",\"resourceAttributes\":{\"name\":\"projects/example-security-prj\",\"service\":\"resourcemanager\",\"type\":\"resourcemanager.projects\"}}],\"methodName\":\"v1.compute.instances.aggregatedList\",\"numResponseItems\":\"176\",\"request\":{\"@type\":\"type.googleapis.com/compute.instances.aggregatedList\"},\"requestMetadata\":{\"callerIp\":\"203.0.113.193\",\"callerSuppliedUserAgent\":\"google-cloud-sdk gcloud/578.0.0 command/gcloud.compute.instances.list invocation-id/cccccccc33333333dddddddd44444444 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)\",\"destinationAttributes\":{},\"requestAttributes\":{\"auth\":{},\"time\":\"2026-08-04T13:59:56.793545Z\"}},\"resourceLocation\":{\"currentLocations\":[\"global\"]},\"resourceName\":\"projects/example-security-prj/global/instances\",\"serviceName\":\"compute.googleapis.com\",\"status\":{}},\"receiveTimestamp\":\"2026-08-04T13:59:57.095923261Z\",\"resource\":{\"labels\":{\"location\":\"global\",\"method\":\"compute.instances.aggregatedList\",\"project_id\":\"example-security-prj\",\"service\":\"compute.googleapis.com\",\"version\":\"v1\"},\"type\":\"api\"},\"severity\":\"INFO\",\"timestamp\":\"2026-08-04T13:59:56.540872Z\"}",
        "@timestamp": "2026-08-04T13:59:56.540872Z",
        "cloud": {
            "project": {
                "id": "example-security-prj"
            }
        ...
        "google_cloud_audit": {
            "insertId": "k9t2u5c8m3e1",
            "logName": "projects/example-security-prj/logs/cloudaudit.googleapis.com%2Fdata_access",
            "protoPayload": {
                "authenticationInfo": {
                    "serviceAccountKeyName": "//iam.googleapis.com/projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc"
                },
                "authorizationInfo": [
                    {
                        "granted": true,
                        ...
                        "resource": "projects/example-security-prj",
                        "resourceAttributes": {
                            "name": "projects/example-security-prj",
                ...
                "requestMetadata": {
                    "requestAttributes": {
                        "time": "2026-08-04T13:59:56.793545Z"
                    }
                },
                "resourceLocation": {
                    "currentLocations": [
                ...
                "resourceName": "projects/example-security-prj/global/instances",
                "type": "type.googleapis.com/google.cloud.audit.AuditLog"
            },
            "receiveTimestamp": "2026-08-04T13:59:57.095923261Z",
            "resource": {
                "labels": {
                    "location": "global",
            ...
            "service_account": {
                ...
                "key": {
                    "id": "aaaaaaaa11111111bbbbbbbb22222222cccccccc",
                    "name": "//iam.googleapis.com/projects/example-security-prj/serviceAccounts/111111111111-compute@example.com/keys/aaaaaaaa11111111bbbbbbbb22222222cccccccc"
                }
            },
            "severity": "INFO"
        },
        ...
        "user_agent": {
            ...
            "name": "Other",
            "original": "google-cloud-sdk gcloud/578.0.0 command/gcloud.compute.instances.list invocation-id/cccccccc33333333dddddddd44444444 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)",
            "os": {
                "name": "Linux",
                "version": "6.12.74"
            }
...
|`google_cloud_audit.protoPayload.authenticationInfo.serviceAccountKeyName` | `keyword` | Resource name of the service account key that authenticated the API request. |
...
|`google_cloud_audit.protoPayload.response.name` | `keyword` | Resource name of the service account key returned in the API response. |
...
|`google_cloud_audit.service_account.email` | `keyword` | Email address of the service account associated with the service account key. |
|`google_cloud_audit.service_account.key.id` | `keyword` | Unique identifier of the service account key. |
|`google_cloud_audit.service_account.key.key_algorithm` | `long` | Algorithm used by the service account key. |
|`google_cloud_audit.service_account.key.key_origin` | `long` | Origin of the service account key material. |
|`google_cloud_audit.service_account.key.key_type` | `long` | Type of the service account key. |
|`google_cloud_audit.service_account.key.name` | `keyword` | Full resource name of the service account key. |
|`google_cloud_audit.service_account.key.private_key_type` | `long` | Format type of the private key associated with the service account key. |
|`google_cloud_audit.service_account.key.valid_after_time` | `long` | Unix timestamp in seconds when the service account key becomes valid. |
|`google_cloud_audit.service_account.key.valid_before_time` | `long` | Unix timestamp in seconds when the service account key expires. |
