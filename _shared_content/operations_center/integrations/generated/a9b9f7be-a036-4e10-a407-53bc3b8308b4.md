...
=== "test_usermanagement_case1_app_role_assignment.json"

    ```json
	
    {
        "message": "{\"id\":\"Directory_00000000-0000-0000-0000-000000000001_CASEA_000001\",\"activityDateTime\":\"2026-07-14T21:02:03.904771+00:00\",\"activityDisplayName\":\"Add app role assignment grant to user\",\"additionalDetails\":[{\"key\":\"User-Agent\",\"value\":\"Mozilla/5.0\"},{\"key\":\"AppId\",\"value\":\"00000000-0000-0000-0000-0000000000aa\"},{\"key\":\"ServicePrincipalProvisioningType\",\"value\":\"Other\"}],\"category\":\"UserManagement\",\"correlationId\":\"00000000-0000-0000-0000-00000000ca01\",\"initiatedBy\":{\"user\":{\"displayName\":\"Registered Apps Portal\",\"id\":\"00000000-0000-0000-0000-00000000a001\",\"@odata.type\":\"#microsoft.graph.userIdentity\",\"userType\":null,\"agentType\":\"notAgentic\",\"homeTenantId\":null,\"homeTenantName\":null,\"ipAddress\":\"2001:db8::31\",\"userPrincipalName\":\"actor.one@example.com\"}},\"loggedByService\":\"Core Directory\",\"operationType\":\"Assign\",\"result\":\"success\",\"resultReason\":\"\",\"targetResources\":[{\"displayName\":\"Example Service Principal\",\"id\":\"00000000-0000-0000-0000-00000000sp01\",\"modifiedProperties\":[{\"displayName\":\"User.ObjectID\",\"newValue\":\"\\\"00000000-0000-0000-0000-00000000a001\\\"\"},{\"displayName\":\"User.UPN\",\"newValue\":\"\\\"actor.one@example.com\\\"\"}],\"type\":\"ServicePrincipal\"},{\"id\":\"00000000-0000-0000-0000-00000000a001\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"actor.one@example.com\"}]}\n",
        "event": {
            "action": "Add app role assignment grant to user",
            "category": [
                "iam"
...
=== "test_usermanagement_case2_update_user.json"

    ```json
	
    {
        "message": "{\"id\":\"Directory_00000000-0000-0000-0000-000000000002_CASEB_000002\",\"activityDateTime\":\"2026-07-14T18:42:54.608120+00:00\",\"activityDisplayName\":\"Update user\",\"additionalDetails\":[{\"key\":\"id\",\"value\":\"00000000-0000-0000-0000-0000000000b1\"},{\"key\":\"seq\",\"value\":\"5\"}],\"category\":\"UserManagement\",\"correlationId\":\"00000000-0000-0000-0000-00000000cb02\",\"initiatedBy\":{\"user\":{\"displayName\":\"Office 365 Admin Portal\",\"id\":\"00000000-0000-0000-0000-00000000a002\",\"@odata.type\":\"#microsoft.graph.userIdentity\",\"userType\":null,\"agentType\":\"notAgentic\",\"homeTenantId\":null,\"homeTenantName\":null,\"ipAddress\":\"2001:db8::10\",\"userPrincipalName\":\"actor.two@example.com\"}},\"loggedByService\":\"Core Directory\",\"operationType\":\"Update\",\"result\":\"success\",\"resultReason\":\"\",\"targetResources\":[{\"id\":\"00000000-0000-0000-0000-00000000t002\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"target.one@example.com\"}]}\n",
        "event": {
            "action": "Update user",
            "category": [
                "iam"
...
=== "test_usermanagement_case3_change_user_license.json"

    ```json
	
    {
        "message": "{\"id\":\"Directory_00000000-0000-0000-0000-000000000003_CASEC_000003\",\"activityDateTime\":\"2026-07-14T18:42:54.614120+00:00\",\"activityDisplayName\":\"Change user license\",\"additionalDetails\":[{\"key\":\"id\",\"value\":\"00000000-0000-0000-0000-0000000000c1\"},{\"key\":\"seq\",\"value\":\"1\"}],\"category\":\"UserManagement\",\"correlationId\":\"00000000-0000-0000-0000-00000000cc03\",\"initiatedBy\":{\"user\":{\"displayName\":\"Office 365 Admin Portal\",\"id\":\"00000000-0000-0000-0000-00000000a003\",\"@odata.type\":\"#microsoft.graph.userIdentity\",\"userType\":null,\"agentType\":\"notAgentic\",\"homeTenantId\":null,\"homeTenantName\":null,\"ipAddress\":\"2001:db8::11\",\"userPrincipalName\":\"actor.three@example.com\"}},\"loggedByService\":\"Core Directory\",\"operationType\":\"Update\",\"result\":\"success\",\"resultReason\":\"\",\"targetResources\":[{\"id\":\"00000000-0000-0000-0000-00000000t003\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"target.two@example.com\"}]}\n",
        "event": {
            "action": "Change user license",
            "category": [
                "iam"
...
=== "test_usermanagement_multiple_target_users_actor_excluded.json"

    ```json
	
    {
        "message": "{\"id\":\"Directory_00000000-0000-0000-0000-00000000d002_EDGE_000002\",\"activityDateTime\":\"2026-07-15T10:11:10.000000+00:00\",\"activityDisplayName\":\"Update user\",\"additionalDetails\":[{\"key\":\"id\",\"value\":\"edge-2\"}],\"category\":\"UserManagement\",\"correlationId\":\"00000000-0000-0000-0000-00000000cd02\",\"initiatedBy\":{\"user\":{\"displayName\":\"Admin Portal\",\"id\":\"00000000-0000-0000-0000-00000000a102\",\"@odata.type\":\"#microsoft.graph.userIdentity\",\"ipAddress\":\"2001:db8::22\",\"userPrincipalName\":\"actor.multi@example.com\"}},\"loggedByService\":\"Core Directory\",\"operationType\":\"Update\",\"result\":\"success\",\"resultReason\":\"\",\"targetResources\":[{\"id\":\"00000000-0000-0000-0000-00000000a102\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"actor.multi@example.com\"},{\"id\":\"00000000-0000-0000-0000-00000000t202\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"target.multi@example.com\"},{\"id\":\"00000000-0000-0000-0000-00000000t203\",\"modifiedProperties\":[],\"type\":\"User\",\"userPrincipalName\":\"target.second@example.com\"}]}\n",
        "event": {
            "action": "Update user",
            "category": [
                "iam"
        ...
        "@timestamp": "2026-07-15T10:11:10Z",
        "action": {
            "properties": [
                {
                    "id": "00000000-0000-0000-0000-00000000t202",
                    "name": "target.multi@example.com",
                    "type": "targetedUser"
                },
                {
                    "id": "00000000-0000-0000-0000-00000000t203",
                    "name": "target.second@example.com",
                    "type": "targetedUser"
                }
            ]
        },
        ...
        "azuread": {
            "correlationId": "00000000-0000-0000-0000-00000000cd02"
        },
        "cloud": {
            "provider": "Azure",
            "service": {
        ...
        "trace": {
            "id": "00000000-0000-0000-0000-00000000cd02"
        },
        "user": {
            "email": "actor.multi@example.com",
            "id": "00000000-0000-0000-0000-00000000a102",
            "name": "actor.multi@example.com",
            "target": {
                "email": "target.multi@example.com",
                "id": "00000000-0000-0000-0000-00000000t202",
                "name": "target.multi@example.com"
            }
        }
...
=== "test_usermanagement_target_user_displayname_fallback.json"

    ```json
	
    {
        "message": "{\"id\":\"Directory_00000000-0000-0000-0000-00000000d001_EDGE_000001\",\"activityDateTime\":\"2026-07-15T10:10:10.000000+00:00\",\"activityDisplayName\":\"Update user\",\"additionalDetails\":[{\"key\":\"id\",\"value\":\"edge-1\"}],\"category\":\"UserManagement\",\"correlationId\":\"00000000-0000-0000-0000-00000000cd01\",\"initiatedBy\":{\"user\":{\"displayName\":\"Admin Portal\",\"id\":\"00000000-0000-0000-0000-00000000a101\",\"@odata.type\":\"#microsoft.graph.userIdentity\",\"ipAddress\":\"2001:db8::21\",\"userPrincipalName\":\"actor.edge@example.com\"}},\"loggedByService\":\"Core Directory\",\"operationType\":\"Update\",\"result\":\"success\",\"resultReason\":\"\",\"targetResources\":[{\"id\":\"00000000-0000-0000-0000-00000000t101\",\"displayName\":\"Target Without UPN\",\"modifiedProperties\":[],\"type\":\"User\"}]}\n",
        "event": {
            "action": "Update user",
            "category": [
                "iam"
        ...
        "@timestamp": "2026-07-15T10:10:10Z",
        "action": {
            "properties": [
                {
                    "id": "00000000-0000-0000-0000-00000000t101",
                    "name": "target without upn",
                    "type": "targetedUser"
                }
            ]
        },
        ...
        "azuread": {
            "correlationId": "00000000-0000-0000-0000-00000000cd01"
        },
        "cloud": {
            "provider": "Azure",
            "service": {
        ...
        "trace": {
            "id": "00000000-0000-0000-0000-00000000cd01"
        },
        "user": {
            "email": "actor.edge@example.com",
            "id": "00000000-0000-0000-0000-00000000a101",
            "name": "actor.edge@example.com",
            "target": {
                "id": "00000000-0000-0000-0000-00000000t101",
                "name": "Target Without UPN"
            }
