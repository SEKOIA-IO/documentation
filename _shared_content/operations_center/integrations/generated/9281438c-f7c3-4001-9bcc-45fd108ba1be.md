...
=== "Event_2889.json"
    ...
    {
        "message": "{\"EventTime\": \"2025-10-14T09:29:45.014973+02:00\", \"Hostname\": \"HOSTNAME.example.com\", \"Keywords\": \"0x80000000000000\", \"LevelValue\": 4, \"EventType\": \"INFO\", \"SeverityValue\": 2, \"Severity\": \"INFO\", \"EventID\": 2889, \"SourceName\": \"ADAM [NCA] LDAP\", \"ProviderGuid\": null, \"Version\": null, \"TaskValue\": 16, \"OpcodeValue\": null, \"RecordNumber\": 1234567, \"ExecutionProcessID\": null, \"ExecutionThreadID\": null, \"Channel\": \"ADAM (NCA)\", \"Domain\": \"NT AUTHORITY\", \"AccountName\": \"ANONYMOUS LOGON\", \"UserID\": \"S-1-2-3\", \"AccountType\": \"Well Known Group\", \"Message\": \"The following client performed a SASL (Negotiate/Kerberos/NTLM/Digest) LDAP bind without requesting signing (integrity verification), or performed a simple bind over a clear text (non-SSL/TLS-encrypted) LDAP connection. \\r\\n \\r\\nClient IP address:\\r\\n1.2.3.4:51216 \\r\\nIdentity the client attempted to authenticate as:\\r\\nS-1-00-1-1111111-2222222222-3333333333-4444444444 \\r\\nBinding Type:\\r\\n1\", \"Category\": \"LDAP Interface\", \"Level\": \"Information\", \"Data\": \"1.2.3.4:51216\", \"Data_1\": \"S-1-00-1-1111111-2222222222-3333333333-4444444444\", \"Data_2\": \"1\", \"EventReceivedTime\": \"2025-10-14T09:29:45.561903+02:00\", \"SourceModuleName\": \"eventlog1\", \"SourceModuleType\": \"im_msvistalog\"}",
        "event": {
            "code": "2889",
...
|`action.properties.AuthenticationProvider` | `keyword` |  |
|`action.properties.AuthenticationServer` | `keyword` |  |
|`action.properties.AuthenticationType` | `keyword` |  |
|`action.properties.BytesTotal` | `long` |  |
|`action.properties.CVEID` | `keyword` |  |
...
|`action.properties.ClientIPAddress` | `keyword` |  |
|`action.properties.ClientName` | `keyword` |  |
...
|`action.properties.DestinationDRA` | `keyword` |  |
...
|`action.properties.EAPType` | `keyword` |  |
|`action.properties.EndUSN` | `keyword` |  |
...
|`action.properties.Ipaddress` | `keyword` |  |
|`action.properties.Issuer` | `keyword` |  |
...
|`action.properties.MessageNumber` | `keyword` |  |
|`action.properties.MessageTotal` | `keyword` |  |
...
|`action.properties.NASIdentifier` | `keyword` |  |
|`action.properties.NASPort` | `keyword` |  |
|`action.properties.NASPortType` | `keyword` |  |
|`action.properties.NamingContext` | `keyword` |  |
|`action.properties.NetworkPolicyName` | `keyword` |  |
|`action.properties.New Value` | `keyword` |  |
|`action.properties.NewName` | `keyword` |  |
|`action.properties.NewSd` | `keyword` |  |
...
|`action.properties.ObjectDN` | `keyword` |  |
|`action.properties.ObjectGUID` | `keyword` |  |
...
|`action.properties.OldSd` | `keyword` |  |
...
|`action.properties.ProxyPolicyName` | `keyword` |  |
...
|`action.properties.SessionID` | `keyword` |  |
...
|`action.properties.SourceDRA` | `keyword` |  |
...
|`action.properties.StartUSN` | `keyword` |  |
