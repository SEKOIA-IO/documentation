...
=== "ad"
    ...
    ```json
	{
        ...
        "ActorContextId": "ANONYMIZED_VALUE",
        ...
        "TargetContextId": "ANONYMIZED_VALUE",
...
=== "browser_log"
	...
	{
        "AppAccessContext": {
            "AADSessionId": "ANONYMIZED_VALUE",
            "CorrelationId": "ANONYMIZED_VALUE",
            "UniqueTokenId": "ANONYMIZED_VALUE"
        },
...
=== "clientipadress"
    ...
    ```json
	{
        ...
        "RecordType": 50,
        "ResultStatus": "Succeeded",
        "UserKey": "ANONYMIZED_VALUE",
        "UserType": 5,
        "Version": 1,
        "Workload": "Exchange",
        "UserId": "ANONYMIZED_VALUE",
        "AppId": "ANONYMIZED_VALUE",
        ...
        "MailboxGuid": "ANONYMIZED_VALUE",
        "MailboxOwnerSid": "S-1-5-21-xxxx-xxx-xxx-xxxx",
        "MailboxOwnerUPN": "ANONYMIZED_VALUE",
        "OperationProperties": [
            {
                "Name": "MailAccessType",
                "Value": "Bind"
        ...
        "Folders": [
            {
                "FolderItems": [
                    {
                        "ClientRequestId": "ANONYMIZED_VALUE",
                        "Id": "aaaaaaaaaaaaa",
...
=== "exchange_item_group_4"
    ...
    ```json
	{
        ...
        "TokenTenantId": "ANONYMIZED_VALUE",
...
=== "exchange_item_group_7"
    ...
    ```json
	{
        "AppAccessContext": {
            "AADSessionId": "ANONYMIZED_VALUE",
            "APIId": "ANONYMIZED_VALUE",
            "ClientAppId": "ANONYMIZED_VALUE",
        ...
        "ClientIPAddress": "1.2.3.4",
        "ClientInfoString": "Client=OWA;Action=ViaProxy",
        "DeviceId": "ANONYMIZED_VALUE",
        "ExternalAccess": false,
        "InternalLogonType": 0,
        "LogonType": 0,
        "LogonUserSid": "S-1-5-21-0000000000-0000000000-0000000000-00000",
        "MailboxGuid": "ANONYMIZED_VALUE",
        "MailboxOwnerSid": "S-1-5-21-0000000000-0000000000-0000000000-00000",
        "MailboxOwnerUPN": "user1",
        "OperationProperties": [
            {
                "Name": "MailAccessType",
        ...
        "TokenObjectId": "ANONYMIZED_VALUE",
        "TokenTenantId": "ANONYMIZED_VALUE",
        "Folders": [
            {
                "FolderItems": [
...
=== "file_size"
    ...
    ```json
	{
        ...
        "IsManagedDevice": false,
        "ItemType": "File",
        "ListId": "ANONYMIZED_VALUE",
        "ListItemUniqueId": "ANONYMIZED_VALUE",
...
=== "security_compliance_alert"
    ...
    ```json
	{
        ...
        "Version": 1,
        "Workload": "SecurityComplianceCenter",
        "ObjectId": "ANONYMIZED_VALUE",
        "UserId": "SecurityComplianceAlerts",
        "AlertId": "ANONYMIZED_VALUE",
        "AlertLinks": [
            {
                "AlertLinkHref": ""
            }
...
=== "targetusername"
    ...
    ```json
	{
        ...
        "ClientIP": "1.2.3.4",
        "UserId": "user1",
        "ApplicationId": "ANONYMIZED_VALUE",
        "AuthenticationType": "OAuth",
        "BrowserName": "Edge",
...
=== "teams_with_foreign_tenant_users_2"
    ...
    ```json
	{
        ...
        "ResourceTenantId": "ANONYMIZED_VALUE",
