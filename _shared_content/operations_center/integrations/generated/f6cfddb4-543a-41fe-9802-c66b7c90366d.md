...
=== "test_conference_owner_changed_participants.json"
...
=== "test_session_start_participants.json"
...
=== "test_session_start_participants_list.json"
...
|`beyondtrust.pra.destination_gsnumber` | `keyword` | Identifier of the destination of the event inside the session |
|`beyondtrust.pra.destination_name` | `keyword` |  |
|`beyondtrust.pra.destination_type` | `keyword` |  |
|`beyondtrust.pra.file_delete_count` | `long` | Number of files deleted during the session |
|`beyondtrust.pra.file_move_count` | `long` | Number of files moved during the session |
|`beyondtrust.pra.file_transfer_count` | `long` | Number of files transferred during the session |
...
|`beyondtrust.pra.primary_rep.gsnumber` | `keyword` | Identifier of the primary representative inside the session |
|`beyondtrust.pra.primary_rep.name` | `keyword` | Name of the primary representative of the session |
