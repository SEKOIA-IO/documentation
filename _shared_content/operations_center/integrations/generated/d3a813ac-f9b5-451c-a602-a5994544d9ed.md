...
=== "event_cognito.json"
    ...
    {
        "message": "{\"eventVersion\": \"1.11\", \"userIdentity\": {\"type\": \"Unknown\", \"principalId\": \"Anonymous\"}, \"eventTime\": \"2026-02-18T00:31:57Z\", \"eventSource\": \"cognito-idp.amazonaws.com\", \"eventName\": \"ChangePassword\", \"awsRegion\": \"eu-central-1\", \"sourceIPAddress\": \"1.1.1.1\", \"userAgent\": \"aws-sdk-js/3.895.0 ua/2.1 os/linux#5.10.247-277.989.amzn2.x86_64 lang/js md/nodejs#22.22.0 api/cognito-identity-provider#3.895.0 exec-env/AWS_Lambda_nodejs22.x m/E app/PT/NO-OP/2.28.0/PTEnv/AWS_Lambda_nodejs22.x\", \"requestParameters\": {\"previousPassword\": \"HIDDEN_DUE_TO_SECURITY_REASONS\", \"proposedPassword\": \"HIDDEN_DUE_TO_SECURITY_REASONS\", \"accessToken\": \"HIDDEN_DUE_TO_SECURITY_REASONS\"}, \"responseElements\": null, \"additionalEventData\": {\"sub\": \"33333333-3333-3333-3333-333333333333\"}, \"requestID\": \"22222222-2222-2222-2222-222222222222\", \"eventID\": \"11111111-1111-1111-1111-111111111111\", \"readOnly\": false, \"eventType\": \"AwsApiCall\", \"managementEvent\": true, \"recipientAccountId\": \"111111111\", \"eventCategory\": \"Management\", \"tlsDetails\": {\"tlsVersion\": \"TLSv1.3\", \"cipherSuite\": \"TLS_AES_128_GCM_SHA256\", \"clientProvidedHostHeader\": \"cognito-idp.eu-central-1.amazonaws.com\"}}",
        "event": {
        ...
        "@timestamp": "2026-02-18T00:31:57Z",
        "action": {
            "name": "ChangePassword",
            "outcome": "success",
            "properties": {
        ...
        "aws": {
            "cloudtrail": {
                "flattened": {
                    "request_parameters": "{\"accessToken\":\"HIDDEN_DUE_TO_SECURITY_REASONS\",\"previousPassword\":\"HIDDEN_DUE_TO_SECURITY_REASONS\",\"proposedPassword\":\"HIDDEN_DUE_TO_SECURITY_REASONS\"}"
                },
        ...
        "user_agent": {
            ...
            "name": "Other",
            "original": "aws-sdk-js/3.895.0 ua/2.1 os/linux#5.10.247-277.989.amzn2.x86_64 lang/js md/nodejs#22.22.0 api/cognito-identity-provider#3.895.0 exec-env/AWS_Lambda_nodejs22.x m/E app/PT/NO-OP/2.28.0/PTEnv/AWS_Lambda_nodejs22.x",
            "os": {
                "name": "Linux"
            }
        }
...
=== "event_ec2_describe_instances.json"
...
=== "event_iam_list_access_keys.json"
	...
	
    {
        ...
        "action": {
            ...
            "properties": {
                ...
                "userIdentity": {
                    "accountId": "1111111111",
                    "arn": "arn:aws:sts::1111111111:assumed-role/user1",
...
=== "event_secretsmanager_list_secrets.json"
...
=== "event_secretsmanager_list_secrets_denied.json"
...
=== "event_ssm_describe_parameters.json"
...
=== "event_sts_get_caller_identity_in_scope_of.json"
        ...
        "action": {
            ...
            "properties": {
                ...
                "userIdentity": {
                    "accountId": "1111111111",
                    "arn": "arn:aws:sts::1111111111:assumed-role/role/1111111111111111111111111",
                    "principalId": "AROA00000000000000:1111111111111111111111111",
                    "sessionContext": {
                        "attributes": {
                            "mfaAuthenticated": "false"
                        },
...
|`action.properties.userIdentity.inScopeOf.credentialsIssuedTo` | `keyword` | ARN of the resource that received the issued credentials |
|`action.properties.userIdentity.inScopeOf.issuerType` | `keyword` | Type of the AWS issuer that scoped the credentials |
...
|`aws.cloudtrail.response_elements.policy.arn` | `keyword` | provides information about the queried policy arn |
|`aws.cloudtrail.response_elements.policy.policyId` | `keyword` | provides information about the queried policyId |
|`aws.cloudtrail.response_elements.policy.policyName` | `keyword` | provides information about the queried policyName |
|`aws.cloudtrail.response_elements.user.userName` | `keyword` | The name of the user in the response |
|`aws.cloudtrail.sub` | `keyword` | The sub identifier of the user |
|`aws.cloudtrail.user_identity.inScopeOf.credentialsIssuedTo` | `keyword` | ARN of the resource that received the issued credentials |
|`aws.cloudtrail.user_identity.inScopeOf.issuerType` | `keyword` | Type of the AWS issuer that scoped the credentials |
