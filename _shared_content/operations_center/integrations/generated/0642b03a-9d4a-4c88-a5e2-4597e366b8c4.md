...
=== "session_logs_type3_wo_hostname.json"
    ...
    {
        "message": "Event [11111111] [1-1] [2024-06-18T22:45:08.003776Z] [vim.event.UserLogoutSessionEvent] [info] [user1.com\\user1] [] [22222222] [User user1.com\\user1@127.0.0.1 logged out (login time: Tuesday, 18 June, 2024 10:45:07 PM, number of API invocations: 2, user agent: VMware vim-java 1.0)]",
        "event": {
            "category": [
                "authentication"
            ],
            "code": "vim.event.UserLogoutSessionEvent",
            "outcome": "success",
            "reason": "User user1.com\\user1@127.0.0.1 logged out",
            "type": [
                "end"
            ]
        },
