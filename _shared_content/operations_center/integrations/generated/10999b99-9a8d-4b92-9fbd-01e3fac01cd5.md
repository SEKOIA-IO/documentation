...
=== "telemetry_event_32.json"
	...
	
    {
        ...
        "sekoiaio": {
            "intake": {
                "parsing_warnings": [
                    "Can't set field observer.ip = '{{parsed_event.message.LocalAddressIP4}}' at stage 'set_common_fields' : Can't convert field observer.ip:1.2.3.4 11.22.33.44 to type ip : '1.2.3.4 11.22.33.44' does not appear to be an IPv4 or IPv6 address"
                ]
            }
        },
        "crowdstrike": {
