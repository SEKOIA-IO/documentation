...
=== "AUTHN_ATTEMPT.json"
	...
	
    {
        ...
        "pingfederate": {
            ...
            "connectionid": "https://testcorpx.example.com",
        ...
        "url": {
            "domain": "testcorpx.example.com",
            "full": "https://testcorpx.example.com",
            "original": "https://testcorpx.example.com",
            "port": 443,
            "registered_domain": "example.com",
            "scheme": "https",
            "subdomain": "testcorpx",
...
=== "AUTHN_REQUEST.json"
	...
	
    {
        ...
        "pingfederate": {
            ...
            "connectionid": "https://eu.example.com/auth/saml/sp/metadata/ag9lfndlYmZpbGluZ3MtZXVyFAsSB0FjY291bnQYgIDA8syI6ggM/",
        ...
        "url": {
            ...
            "full": "https://eu.example.com/auth/saml/sp/metadata/ag9lfndlYmZpbGluZ3MtZXVyFAsSB0FjY291bnQYgIDA8syI6ggM/",
            "original": "https://eu.example.com/auth/saml/sp/metadata/ag9lfndlYmZpbGluZ3MtZXVyFAsSB0FjY291bnQYgIDA8syI6ggM/",
...
=== "AUTHN_SESSIONS_DELETED.json"
	...
	
    {
        ...
        "host": {
            "name": "host01.test.internal.test"
        },
        "pingfederate": {
            "attributes": "\"\"",
            ...
            "trusted_network": "YES",
            "x_forwarded_host": "hub-mtls.auth.example.com",
            "x_forwarded_vip": "hub-mtls.auth.test.internal.test"
        },
        "related": {
            "hosts": [
                "hub-mtls.auth.example.com"
...
=== "AUTHN_SESSION_CREATED.json"
    ...
    {
        "message": "2025-08-30 22:27:50,474 trackingid=\"tid:vpYkkHbUv895EJQob3vhMrTbIgc\" transactionid=\"DW83XpRRPgoKBAY7gru6YIR81\" event=\"AUTHN_SESSION_CREATED\" subject=\"\" ip=\"192.0.2.10\" connectionid=\"https://hub.auth.example.com/PasswordProtectedTransport\" protocol=\"SAML20\" pfhost=\"host03.test.internal.test\" role=\"IdP\" status=\"\" responsetime=\"50\" assertionid=\"\" attrackingid=\"\" attributes=\"\"  authenticationsourceid=\"adapter.AdpRequestedUser\" authnsessionexpiry=\"2025-08-30 23:27:50.474+0000\" connectionname=\"HUB Password Only\" granttype=\"\" X-Forwarded-Vip=\"login.auth.test.internal.test\" X-Forwarded-Host=\"login.auth.example.com\" trustedNetwork=\"YES\" requestid=\"\" sri=\"vpYkkHbUv895EJQob3vhMrTbIgc..s3rm\" virtualserverid=\"https://login.auth.example.com/PasswordProtectedTransport\"",
        "event": {
            "category": [
                "authentication"
            ],
        ...
        "host": {
            "name": "host03.test.internal.test"
        },
        "network": {
            "protocol": "saml20"
        },
        "pingfederate": {
            ...
            "x_forwarded_vip": "login.auth.test.internal.test"
        },
        "related": {
            "hosts": [
        ...
        "url": {
            ...
            "full": "https://hub.auth.example.com/PasswordProtectedTransport",
...
=== "AUTHN_SESSION_USED.json"
	...
	
    {
        ...
        "pingfederate": {
            ...
            "connectionid": "https://testapp-uat.example.com/",
            ...
            "virtualserverid": "https://hub-mtls.auth.example.com",
            "x_forwarded_host": "hub-mtls.auth.example.com",
            "x_forwarded_vip": "hub-mtls.auth.test.example.com"
        },
        "related": {
            "hosts": [
                "hub-mtls.auth.example.com"
        ...
        "url": {
            "domain": "testapp-uat.example.com",
            "full": "https://testapp-uat.example.com/",
            "original": "https://testapp-uat.example.com/",
            "path": "/",
            "port": 443,
            "registered_domain": "example.com",
            "scheme": "https",
            "subdomain": "testapp-uat",
            "top_level_domain": "com"
        }
    }
...
=== "OAuth.json"
	...
	
    {
        ...
        "host": {
            "name": "host04.test.internal.test"
        },
        "network": {
            "protocol": "oauth20"
        },
...
=== "SLO.json"
	...
	
    {
        ...
        "host": {
            "name": "host02.test.internal.test"
        },
        "network": {
            "protocol": "oidc"
        },
...
=== "SSO.json"
	...
	
    {
        ...
        "event": {
            ...
            "module": "pingfederate",
            "outcome": "failure",
            "reason": "trackingid=\"tid:ehyqnk7ad5LMT2Cy03kgCgx2wPg\" transactionid=\"LyPg0FbetfoyVw624lDxuktdk\" event=\"SSO\" subject=\"j.doe\" ip=\"192.0.2.15\" connectionid=\"https://app01.example.com/ssoagent\" protocol=\"SAML20\" pfhost=\"host04.test.example.com\" role=\"IdP\" status=\"failure\" responsetime=\"86\" assertionid=\"sC7AvBm1doxsGBy7ehlR1ik.4ZS\" attrackingid=\"\" attributes=\"SAML_AUTHN_INSTANT=2025-09-02T02:10:07.629Z, SAML_AUTHN_CTX=urn:testcorp:oneaccess:ac:classes:strong, SAML_SUBJECT=testuser2, SAML_NAME_FORMAT=urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified\"  authenticationsourceid=\"\" authnsessionexpiry=\"\" connectionname=\"TestRegion_HRM\" granttype=\"\" X-Forwarded-Vip=\"hub-mtls.auth.test.example.com\" X-Forwarded-Host=\"hub-mtls.auth.example.com\" trustedNetwork=\"YES\" requestid=\"o8ere_Dij45ft_zFRmzhBt6wimN\" sri=\"ehyqnk7ad5LMT2Cy03kgCgx2wPg..tlH_\" virtualserverid=\"https://hub-mtls.auth.example.com\"",
            "type": [
                "start"
            ]
        },
        ...
        "pingfederate": {
            ...
            "connectionid": "https://app01.example.com/ssoagent",
        ...
        "url": {
            ...
            "full": "https://app01.example.com/ssoagent",
            "original": "https://app01.example.com/ssoagent",
            "path": "/ssoagent",
            "port": 443,
            "registered_domain": "example.com",
            "scheme": "https",
...
=== "heartbeat.json"
    ...
    {
        "message": "2025-09-02 11:02:34,353 tid:Q08PzbPCjfSJL8sbIj88OLO5YWg DEBUG [org.sourceid.websso.servlet.IntegrationControllerServlet] GET: https://hub-mtls.auth-int.test.example.com/pf/heartbeat.ping",
        "event": {
            "category": [
                "web"
            ],
            ...
            "kind": "event",
            "module": "pingfederate",
            "reason": "GET: https://hub-mtls.auth-int.test.example.com/pf/heartbeat.ping",
            "type": [
                "access"
            ]
        },
        ...
        "host": {
            "name": "hub-mtls.auth-int.test.example.com"
        },
        "http": {
            "request": {
                "method": "GET"
        ...
        "url": {
            "domain": "hub-mtls.auth-int.test.example.com",
            "full": "https://hub-mtls.auth-int.test.example.com/pf/heartbeat.ping",
            "original": "https://hub-mtls.auth-int.test.example.com/pf/heartbeat.ping",
            "path": "/pf/heartbeat.ping",
            "port": 443,
            "registered_domain": "example.com",
            "scheme": "https",
            "subdomain": "hub-mtls.auth-int.test",
            "top_level_domain": "com"
        }
    }
...
=== "http_access.json"
    ...
    {
        "message": "1.2.3.4 - john.doe [02/Sep/2025:13:02:34 +0000] \"GET /pf/heartbeat.ping HTTP/1.1\" 200 156",
        "event": {
            "category": [
                "web"
            ],
