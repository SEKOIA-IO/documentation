...
=== "test_empty_bytes.json"

    ```json
	
    {
        "message": "1.2.3.4 - - [26/Aug/2025:11:18:29 +0200] \"POST /index HTTP/1.1\" 401 - \"-\" \"Outlook-iOS-Android/1.0\"",
        "event": {
            "category": [
                "web"
            ],
        ...
        "@timestamp": "2025-08-26T09:18:29Z",
        "http": {
            "request": {
                "method": "POST",
                "referrer": "-"
...
=== "test_security_log_event.json"
	...
	
    {
        ...
        "ubika": {
            "waap": {
                "part_key_match": "passwd",
                "part_value_match": "' or 1=1 --",
                "tokens": {
                    "risk": {
                        "level": "80"
                    }
...
=== "test_security_log_event_with_tags.json"

    ```json
	
    {
        "message": "{\"logAlertUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"timestamp\": \"1769614718399\", \"@timestamp\": \"1769614718399\", \"request\": {\"body\": \"REDACTED\", \"cookies\": [{\"key\": \"ZM_TEST\", \"value\": \"ZM_TEST=true\"}], \"headers\": [{\"key\": \"Content-Type\", \"value\": \"application/vnd.ms-sync.wbxml\"}, {\"key\": \"Accept\", \"value\": \"*/*\"}, {\"key\": \"Authorization\", \"value\": \"******\"}, {\"key\": \"Ms-Asprotocolversion\", \"value\": \"16.1\"}, {\"key\": \"X-Ms-Policykey\", \"value\": \"0\"}, {\"key\": \"Accept-Language\", \"value\": \"fr-FR,fr;q=0.9\"}, {\"key\": \"Accept-Encoding\", \"value\": \"gzip, deflate, br\"}, {\"key\": \"Content-Length\", \"value\": \"113\"}, {\"key\": \"User-Agent\", \"value\": \"Apple-iPhone14C3/2206.76\"}, {\"key\": \"Host\", \"value\": \"example.com\"}, {\"key\": \"X-Client-IP-WAF\", \"value\": \"2.2.2.2\"}, {\"key\": \"X-Forwarded-For\", \"value\": \"2.2.2.2\"}, {\"key\": \"X-Forwarded-Host\", \"value\": \"example.com\"}, {\"key\": \"X-Forwarded-Server\", \"value\": \"example.com\"}], \"hostname\": \"example.com\", \"ipDst\": \"3.3.3.3\", \"ipSrc\": \"2.2.2.2\", \"method\": \"POST\", \"path\": \"/Microsoft-Server-ActiveSync\", \"portDst\": 443, \"protocol\": \"HTTP/2.0\", \"query\": \"User=john.doe&DeviceId=DEVICE_ID&DeviceType=iPhone&Cmd=Sync\", \"requestUid\": \"REQUEST_ID\"}, \"context\": {\"tags\": \"LOGONLY example abcdef\", \"geoipCode\": \"\", \"geoipName\": \"\", \"applianceName\": \"xproxy123\", \"applianceUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"backendHost\": \"1.1.1.1\", \"backendPort\": 80, \"reverseProxyName\": \"xproxy123 - instance production\", \"reverseProxyUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"tunnelName\": \"tunnel example.com #1\", \"tunnelUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"workflowName\": \"WF - DGDDI - example.com - v1.0\", \"workflowUid\": \"68b329da9893e34099c7d8ad5cb9c940\"}, \"events\": [{\"eventUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"tokens\": {\"date\": 1769614718401387, \"eventType\": \"security\", \"engineUid\": \"icxEngine\", \"engineName\": \"ICX Engine\", \"attackFamily\": \"Command Injection\", \"riskLevel\": 80, \"riskLevelOWASP\": 8.0, \"cwe\": \"CWE-77\", \"severity\": 5, \"resolveType\": \"Default Resolve\", \"part\": \"Multiple\", \"icxPolicyName\": \"DGDDI - ICX - 3.46 example.com\", \"icxPolicyUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"icxRuleName\": \"Command Injection\", \"icxRuleUid\": \"68b329da9893e34099c7d8ad5cb9c940\", \"matchingParts\": [{\"part\": \"Var_GET\", \"partKey\": \"Cmd\", \"partKeyOperator\": \"pattern\", \"partKeyPatternUid\": \"CommandInjectionProprietaryPattern_CI-00749-3.46.0\", \"partKeyPatternName\": \"Command Injection\", \"partKeyPatternVersion\": \"CI-00749-3.46.0\", \"partKeyMatch\": \"Cmd\", \"partValue\": \"Sync\", \"partValueOperator\": \"regexp\", \"partValuePattern\": \".*\", \"partValueMatch\": \"Sync\", \"attackFamily\": \"Command Injection\", \"riskLevel\": 80, \"riskLevelOWASP\": 8.0, \"cwe\": \"CWE-77\"}], \"reason\": \"ICX Engine: Command Injection in Var_GET 'Cmd'\", \"securityExceptionConfigurationUid\": \"68b329da9893e34099c7d8ad5cb9c940\"}}]}",
        "event": {
            "action": "block",
            "category": [
                "threat"
        ...
        "@timestamp": "2026-01-28T15:38:38.399000Z",
        "destination": {
            "address": "3.3.3.3",
            "ip": "3.3.3.3",
            "port": 443
        ...
        "rule": {
            "description": "ICX Engine: Command Injection in Var_GET 'Cmd'",
            "id": "68b329da9893e34099c7d8ad5cb9c940",
            "name": "DGDDI - ICX - 3.46 example.com"
        },
        "source": {
            "address": "2.2.2.2",
            "ip": "2.2.2.2"
        ...
        "ubika": {
            "waap": {
                "part_key_match": "Cmd",
                "part_value_match": "Sync",
                "tags": "LOGONLY example abcdef",
                "tokens": {
                    "risk": {
                        "level": "80"
                    }
                ...
                "tunnel": {
                    "name": "tunnel example.com #1",
                    "uuid": "68b329da9893e34099c7d8ad5cb9c940"
                },
                "workflow": {
                    "name": "WF - DGDDI - example.com - v1.0",
                    "uuid": "68b329da9893e34099c7d8ad5cb9c940"
                }
            }
        },
        "url": {
            ...
            "query": "User=john.doe&DeviceId=DEVICE_ID&DeviceType=iPhone&Cmd=Sync",
        ...
        "user_agent": {
            ...
            "original": "Apple-iPhone14C3/2206.76",
            "os": {
                "name": "iOS"
            }
        },
...
|`ubika.waap.part_key_match` | `keyword` |  |
|`ubika.waap.part_value_match` | `keyword` |  |
|`ubika.waap.tags` | `keyword` |  |
