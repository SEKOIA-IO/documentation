...
=== "service_account_key_creation"
    ...
    ```json
	{
        ...
        "protoPayload": {
            ...
            "authenticationInfo": {
                "oauthInfo": {
                    "oauthClientId": "900000000000000000001"
                },
                "principalEmail": "111111111111-compute@example.com",
                "principalSubject": "serviceAccount:111111111111-compute@example.com",
                "serviceAccountDelegationInfo": [
                    {
                        "firstPartyPrincipal": {
                            "principalEmail": "service-111111111111@example.com"
                        }
                    }
                ]
            },
            ...
            "request": {
                ...
                "name": "projects/-/serviceAccounts/111111111111-compute@example.com",
                "private_key_type": 2
            },
            "requestMetadata": {
                "callerIp": "203.0.113.193",
                "callerSuppliedUserAgent": "google-cloud-sdk gcloud/578.0.0 command/gcloud.iam.service-accounts.keys.create invocation-id/aaaaaaaa11111111bbbbbbbb22222222 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)",
                "destinationAttributes": {},
                "requestAttributes": {
                    "auth": {},
        ...
        "resource": {
            "labels": {
                "email_id": "111111111111-compute@example.com",
                "project_id": "example-security-prj",
                "unique_id": "900000000000000000001"
            },
            "type": "service_account"
        },
        "severity": "NOTICE",
        "timestamp": "2026-08-04T12:39:51.759122942Z"
    }
    ```



=== "service_account_key_usage"
    ...
    ```json
	{
        ...
        "labels": {
            "compute.googleapis.com/root_trigger_id": "bbbbbbbb-cccc-4ddd-8eee-ffffffffffff"
        },
        ...
        "protoPayload": {
            ...
            "requestMetadata": {
                "callerIp": "203.0.113.193",
                "callerSuppliedUserAgent": "google-cloud-sdk gcloud/578.0.0 command/gcloud.compute.instances.list invocation-id/cccccccc33333333dddddddd44444444 environment/None environment-version/None client-os/LINUX client-os-ver/6.12.74 client-pltf-arch/x86_64 interactive/True from-script/False python/3.14.6 term/xterm  (Linux 6.12.74+deb13+1-cloud-amd64),gzip(gfe)",
                "destinationAttributes": {},
                "requestAttributes": {
                    "auth": {},
