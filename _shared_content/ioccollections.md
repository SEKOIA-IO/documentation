...
IOC Collections are available directly from the menu inside the Intelligence Center with CTI permissions described [here.](../../../../docs/getting_started/Permissions.md)
