...
IOC Collections are available directly from the menu inside the Intelligence Center with CTI permissions describe [here](/getting_started/Permissions.md#cti-permissions/)
